			...
			success:function(data){
				...
				for (var key in data.hm) {
					($('#myTableResults tbody')).append('<tr >'
						...
						+'<td>'+data.hm[key][1]+'</td>'
						+'<td>'+data.hm[key][2]+'</td>'
						+'<td><a href="'+s3pat+'results/'+key+'/'+data.hm[key][3]+'" target="_blank">'+data.hm[key][3]+'</a></td>'
						+'</tr>');
		        }
			},
			error:function(data){}
								...
								<div class="tg-widget tg-widgetaboutusnav">
									...
									<hr style="border: 1px solid black;">
										<ul class="listul" >
											...
											<a href="OldQuestionPapers.jsp"><li class="des">Old Question Papers</li></a>
											<a href="Result.jsp"><li class="des active">Results</li></a>
						     ...
						     <table id="myTableResults" class="Vscroll" style="height: 600px;">
								  			<thead>
								  				<tr>
								  					...
								  					<th style="color: #003135; background: #fdd991;border:1px solid #003135; ">Examination</th>

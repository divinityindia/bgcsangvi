			...
			success:function(data){
				...
				for (var key in data.hm1) {
					...
					($('#OtherDoc')).append('<li type="disc">'
						+'<a href="'+s3pat+'IQAC/IqacOther/'+key+'/'+data.hm1[key][0]+'" target="_blank">'+data.hm1[key][0]+'</a>'
						+'</li>');
		        }
			},
			error:function(data){}
								...
								<div class="tg-widget tg-widgetaboutusnav">
									...
									<hr>
										<ul class="listul" >
											...
											<a href="Otherdoc.jsp"><li class="des active" style="font-size: 13px;">Other Document</li></a>
										</ul>
									</div>
								</div>
							</aside>

			...
			<%-- <center><h1 style="padding:5px;border:0px solid brown; font-weight: bold;">Commerce</h1></center> --%>
				<div class="row" style="margin-top: 2%;">
					<div id="tg-twocolumns" class="tg-twocolumns">
								...
								<div class="tg-widget tg-widgetaboutusnav">
									...
									<hr style="border: 1px solid black;">
										<ul class="listul" >
											...
											<a href="GetDepWiseEvent?did=14&pgnm=CommerceEventandPhotos"><li class="active des">Events & Photos</li></a>
						...
						<h2 class="title_contanier" >Commerce Department Events & Photos</h2>

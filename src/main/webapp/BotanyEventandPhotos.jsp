			...
			<%-- <center><h1 style="padding:5px;border:0px solid brown; font-weight: bold;">Botany</h1></center> --%>
				<div class="row" style="margin-top: 2%;">
					<div id="tg-twocolumns" class="tg-twocolumns">
								...
								<div class="tg-widgetcontent" style="width:100% ;height: 500px;padding-top: 60px; ">
									<hr style="border: 1px solid black;">
										<ul class="listul" >
											...
											<a href="GetDepWiseEvent?did=26&pgnm=BotanyEventandPhotos"><li class="active des">Events & Photos</li></a>
						...
						<h2 class="title_contanier" >Botany Department Events & Photos</h2>

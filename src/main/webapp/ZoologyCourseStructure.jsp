			...
			<div class="container">
				...
				<div class="row" style="margin-top: 2%;">
					<div id="tg-twocolumns" class="tg-twocolumns">
								...
								<div class="tg-widget tg-widgetaboutusnav">
									...
									<hr style="border: 1px solid black;">
										<ul class="listul" >
											...
											<a href="GetDepWiseCourseStruct?did=27&pgnm=ZoologyCourseStructure"><li  class="active des">Course Structure</li></a>
						...
						<h2 class="title_contanier" >Zoology Department Course Structure</h2>

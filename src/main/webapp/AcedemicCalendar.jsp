				...
				<div class="row">
					...
					<br>
						<ol class="tg-breadcrumb">
							...
							<li class="tg-active li" style="display: inline-block;">Academic Calendar</li>
						</ol>
					</div>
				</div>
			</div>
     ...
     <table style="width: 100%;" class="Vscroll">
  			...
  			<c:forEach var="cat" items="${dtl}" varStatus="row">
  				<tr>
  				     ...
  				     <td style="color: black;border:1px solid black;text-align: left;padding: 5px;padding-left: 20px; "><a href="${s3pat}AcedemicCalenderes/${cat.acid}_${cat.document}" target="_blank">${cat.document}</a></td>
  				</tr>
  			</c:forEach>

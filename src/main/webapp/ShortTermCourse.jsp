				...
				success:function(data){
					...
					for (var key in data.hm) {
						($('#myTableShortTermCourse tbody')).append('<tr >'
							...
							+'<td>'+data.hm[key][4]+'</td>'
							+'<td>'+data.hm[key][5]+'</td>'
							+'<td><a href="'+s3pat+'short_term_course/'+key+'/'+data.hm[key][6]+'">'+data.hm[key][6]+'</a></td>'
// 							+'<td>'+data.hm[key][7]+'</td>'
...
<center><h2 class="title_contanier" >Short Term Course</h2></center>
<hr>
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-12">
										...
										<table id="myTableShortTermCourse" class="Vscroll" style="height: 600px;">
								  			<thead>
								  				<tr>
								  					...
								  					<th style="color: #003135; background: #fdd991;border:1px solid #003135; ">Duration</th>
								  					<th style="color: #003135; background: #fdd991;border:1px solid #003135; ">Fees</th>

...
<style>
  ...
  <div class="container">
  <h3 align="center">Department Placement Details </h3>
         <table id="customers" >
							             ...
							             <tr> 
							                 ...
							                 <td  style="text-align: left;"><a href="${s3pat}addPlacement/${cat.value[0]}_${cat.value[3]}" target="_blank" >${cat.value[3]}</a></td>
							             </tr>
							            </c:forEach>
							       </table>

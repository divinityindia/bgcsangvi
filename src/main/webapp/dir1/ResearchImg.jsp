	...
	<style>
		...
		.planeTbl tr:HOVER {
  		...
  		<div  style="border:1px solid #aaa;padding:10px;border-radius:5px;text-align: center">
	  		...
	  		<form action="ResearchImage" method="post"  enctype="multipart/form-data" onsubmit="return chkImg()">
	  			<table  class="planeTbl" style="width:100%">
	  				<tr>
  						...
  						<td>Image Type:- <span class="req">*</span></td>
	  			...
	  			<table id="td1" style="width: 100%;">
					        <thead>
					            <tr>
					                ...
					                <th style="color: #fff; background: #002e3b;border:1px solid #003135; ">DepName</th>
					                <th style="color: #fff; background: #002e3b;border:1px solid #003135; ">Image Type</th>
					        ...
					        <tr>
					             ...
					             <td>${imgs.imgtype}</td>
					             <td>${imgs.imgtitle }</td>
					             <td><img src="${s3path}ResearchImg/${imgs.imgid}_${imgs.image}"style="height: 100px; width: 100px;"/></td>
					             <td><a href="DeleteResImg?id=${imgs.imgid}">Delete</a></td>
					        </tr>
					        </c:forEach> 
					        <tbody>

			...
			success:function(data){
				...
				for (var key in data.hm) {
					($('#myTable tbody')).append('<tr >'
						...
						+'<td>'+data.hm[key][4]+'</td>'
						+'<td>'+data.hm[key][5]+'</td>'
						+'<td><a href="'+s3path+'short_term_course/'+key+'/'+data.hm[key][6]+'">'+data.hm[key][6]+'</a></td>'
						+'<td>'+data.hm[key][7]+'</td>'
  ...
  <div class="container" style="padding:10px">
	...
	<style>
		...
		.planeTbl tr:HOVER {
  		...
  		<h3 style="line-height: 0px;">Short Term Course Manager</h3>
  		<br/>
  			<form action="" method="post" enctype="multipart/form-data">
             <input type="hidden" id="s3path" value="${s3path}">
  			<table class="planeTbl" style="width:100%">
  				...
  				<tr>
					<td>Fees <span class="req">*</span></td>
  					<td><input type="text" class="form-control" name="fees" required/></td>
  				</tr>
  				<tr>
  		...
  		<br/>
  		<b>Already created short term courses:</b>
  		<style>
  			#bottonTh th{
  		...
  		<form action="DeleteShortTermCourse" method="post">
  		<table id="myTable" class="Vscroll">
  			<thead>
  				<tr>
  					...
  					<th style="color: #fff; background: #002e3b;border:1px solid #003135; ">Fees</th>
		        ...
		        <div class="modal-body" style="text-align: center">
					<form action="" method="post" enctype="multipart/form-data">
			  			...
			  			<table class="planeTbl" style="width:100%">
			  				...
			  				<tr>
								<td>Fees <span class="req">*</span></td>
			  					<td><input type="text" class="form-control" name="fees" id="fees-modal" required/></td>
			  				</tr>
			  				<tr>
			  					<td>Upload Document</td>
			  					<td>
		      ...
		      <div class="modal-content">
		        <div class="modal-body" style="text-align: center">
					<br/><br/>
		          	...
		          	<h3 style="color:green">Short term course created successfully</h3>
		      ...
		      <div class="modal-content">
		        <div class="modal-body" style="text-align: center">
					<br/><br/>
		          	...
		          	<h3 style="color:green">Short term course updated successfully</h3>
		      ...
		      <div class="modal-content">
		        <div class="modal-body" style="text-align: center">
					<br/><br/>
		          	...
		          	<h3 style="color:green">Short term course(s) deleted successfully</h3>

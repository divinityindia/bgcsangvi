  ...
  <div class="container" style="padding:10px">
	...
	<style>
		...
		.planeTbl tr:HOVER {
  		...
  		<h3 style="line-height: 0px;">Upload Research / Funding Scheme </h3>
  		<br/>
  		     <script>
	  		function chkPDF(){
  				var f=$('#f1').val();
  			...
  			<form action="ResearchUpload" method="post" enctype="multipart/form-data" onsubmit="return chkPDF()">

  			<table class="planeTbl" style="width:100%">
  				<tr>

  					<td width="10%">Type:- <span class="req">*</span></td>
  					<td width="30%"><select class="form-control" name="title" required="required">
  					                 <option value="">~~ Choose ~~</option>
  					                 <option>Research Infrastructure</option>
  					                 <option>Research Center</option>
  					                 <option>UGC</option>
  					                 <option>Community College Scheme</option>
  					                 <option>DBT Star College Scheme</option>
  					                 <option>DST FIST</option>
  					                 <option>RUSA</option>
...
<!--   					                 <option>Consultancy</option> -->
  					...
  					<td width="15%">Title / Details <span class="req">*</span></td>
  					<td width="45%">
  		...
  		<br/>
  		<b>Already Added Research / Funding Scheme:</b>
  		<style>
  			#bottonTh th{
  		...
  		<table id="myTable" class="Vscroll">
  			...
  			<c:forEach var="cat" items="${dtl}" varStatus="row">
  				<tr>
  				     ...
  				     <td>${cat.title}</td>
  				     <td>${cat.details}</td>
  				     <td><a href="${s3path}ResearchUpload/${cat.rsid}_${cat.document}" target="_blank">${cat.document}</a></td>
  				     <td><a href="DeleteResearchUpload?id=${cat.rsid}">Delete</a></td>
  				</tr>
  			</c:forEach>

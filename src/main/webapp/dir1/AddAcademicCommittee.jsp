  ...
  <div class="container" style="padding:10px">
	...
	<style>
		...
		.planeTbl tr:HOVER {
  		...
  		<h3 style="line-height: 0px;">Add Academic Committee</h3>
  		<br/>
  		     <script>
	  		function chkPDF(){
  				var f=$('#f1').val();
  			...
  			<form action="AcademicCommitteeController" method="post" enctype="multipart/form-data" onsubmit="return chkPDF()">

  			<table class="planeTbl" style="width:100%">
  				<tr>

  					<td width="10%">Title:- <span class="req">*</span></td>
  					<td width="40%"><input type="text" class="form-control" name="title" required>
  					</td>
  		...
  		<br/>
  		<b>Already Added Academic Committees</b>
  		<style>
  			#bottonTh th{
  		...
  		<table id="myTable" class="Vscroll">
  			...
  			<c:forEach var="cat" items="${dtl}" varStatus="row">
  				<tr>
  				     <td>${row.count}</td>
  				     <td>${cat.title}</td>
  				     <td><a href="${s3path}AcademicCommittee/${cat.acid}_${cat.document}" target="_blank">${cat.document}</a></td>
  				     <td><a href="DeleteAcademicCommittee?id=${cat.acid}">Delete</a></td>
  				</tr>
  			</c:forEach>
		      ...
		      <div class="modal-content">
		        <div class="modal-body" style="text-align: center">
					<br/><br/>
		          	...
		          	<h3 style="color:green">New Academic Committees Created successfully</h3>
		      ...
		      <div class="modal-content">
		        <div class="modal-body" style="text-align: center">
					<br/><br/>
		          	...
		          	<h3 style="color:green">Academic Committees updated successfully</h3>
		      ...
		      <div class="modal-content">
		        <div class="modal-body" style="text-align: center">
					<br/><br/>
		          	...
		          	<h3 style="color:green">Academic Committees deleted successfully</h3>

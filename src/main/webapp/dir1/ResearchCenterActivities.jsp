	...
	<style>
		...
		.planeTbl tr:HOVER {
  		...
  		<div  style="border:1px solid #aaa;padding:10px;border-radius:5px;text-align: center">
	  		...
	  		<h3>Add Research Center Activities</h3>
	  		<br/>
		...
		<c:remove var="erMsg"/>
	  		<div class="row">
	  		<form action="ResearchCenterActivitiesController" method="post"  id="frm" >
            ...
            <br><br>
                       ...
                       <h3>Already  Added Research Center Activities</h3>   
					        ...
					        <tbody>
					              ...
					              <tr> 
					                  ...
					                  <td style="text-align: left">${dtls.detls}</td>
					                   <td><a href="DeleteResearchCenterDetails?id=${dtls.rcid}&tab=RC_activ">Delete</a></td>

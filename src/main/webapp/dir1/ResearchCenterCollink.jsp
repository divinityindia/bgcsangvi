	...
	<style>
		...
		.planeTbl tr:HOVER {
  		...
  		<div  style="border:1px solid #aaa;padding:10px;border-radius:5px;text-align: center">
	  		...
	  		<h3>Add Research Center Collaboration and linkages</h3>
	  		<br/>
		...
		<c:remove var="erMsg"/>
	  		<div class="row">
	  		<form action="ResearchCenterCollinkController" method="post"  id="frm" >
            ...
            <br><br>
                       ...
                       <h3>Already  Added Research Center Collaboration and linkages</h3>   
						...
						<table style="width: 100%;" >
					        <thead>
					            <tr>
					                 ...
					                 <th width="10%" style="color: #fff; background: #002e3b;border:1px solid #003135; ">Dept Name</th>
					        ...
					        <tbody>
					              <c:forEach var="dtls" items="${rsdtls}" varStatus="row">
					              <tr> 
					                  <td>${row.count}</td>
					                  <td style="text-align: left">${dtls.deptname}</td>
					                 
					                  <td style="text-align: left">${dtls.detls}</td>
					                   <td><a href="DeleteResearchCenterDetails?id=${dtls.rcid}&tab=RC_cl">Delete</a></td>

		...
		.planeTbl tr:HOVER {
  		...
  		<div  style="border:1px solid #aaa;padding:10px;border-radius:5px;text-align: center">
	  		...
	  		<br/>
                ...
                <br><br>
                    <form action="UpdateDepDtl" method="post"> 
					  <input type="hidden" name="regno" id="regno">
					   ...
					   <c:forEach var="dtls" items="${dtl}">
					     <input type="hidden" name="did" id="did" value="${dtls.did}">
								   ...
								   <tr>
									   ...
									   <td style="font-size: 14px;padding:08px;border: none;color: white; text-align: left;">
										<input type="text" name="heading" id="heading" value="${dtls.heading}" required="required" style="height: 40px;width: 100%; color: black; " class="form-control">
									   </td>
									 ...
									 <tr>
									   ...
									   <td colspan="3" style="font-size: 14px;padding:08px;border: none;color: white; text-align: left;">

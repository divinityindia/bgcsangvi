  ...
  <div class="container" style="padding:10px">
	...
	<style>
		...
		.planeTbl tr:HOVER {
  		...
  		<h3 style="line-height: 0px;">Upload Cyber Security Files</h3>
  		<br/>
  		     <script>
	  		function chkPDF(){
  				var f=$('#f1').val();
  			...
  			<form action="CyberSecurity" method="post" enctype="multipart/form-data" onsubmit="return chkPDF()">

  			<table class="planeTbl" style="width:100%">
  				<tr>

  					<td width="10%">Subject:- <span class="req">*</span></td>
  					<td width="35%"><input type="text" name="sub" value="Cyber Security" readonly="readonly">
  					</td>
  					<td width="15%">Semester:-<span class="req">*</span></td>
  					<td width="40%">
                         <select class="form-control" name="sem" required="required">
  					                 <option value="">~~ Choose ~~</option>
  					                 <option>Part-I Sem-I Module-1</option>
  					                 <option>Part-I Sem-II Module-2</option>
  					                 <option>Part-II Sem-III Module-3</option>
  					                 <option>Part-II Sem-IV Module-4</option>
  					    </select>
  					</td>
  				</tr>
  				
  				<tr>
  				    <td width="10%">Upload Document <span class="req">*</span></td>
  					<td width="40%"><input type="file" id="f1" name="file"/>
  					</td>
  					<td></td>
  					<td>
  		...
  		<br/>
  		<b>Already Added Cyber Security Files:</b>
  		<style>
  			#bottonTh th{
  		...
  		<table id="myTable" class="Vscroll">
  			<thead>
  				<tr>
  					...
  					<th style="color: #fff; background: #002e3b;border:1px solid #003135; ">Semester</th>
  			...
  			<c:forEach var="cat" items="${dtl}" varStatus="row">
  				<tr>
  				     ...
  				     <td>${cat.subject}</td>
  				     <td>${cat.semester}</td>
  				     <td><a href="${s3path}CyberSecurity/${cat.csid}_${cat.document}" target="_blank">${cat.document}</a></td>
  				     <td><a href="DeleteCyberSecurity?id=${cat.csid}">Delete</a></td>
  				</tr>
  			</c:forEach>

	...
	<style>
		...
		.planeTbl tr:HOVER {
  		...
  		<div  style="border:1px solid #aaa;padding:10px;border-radius:5px;text-align: center">
	  		...
	  		<h3>Add E-Resource Details</h3>
	  		<br/>
	  		
	  		<div class="row">
	  		<form action="EresourceUpload" method="post"  id="frm" >
	  		  <div class="col-sm-12" style="border: 1px solid; margin-left: 15px;width: 95%;" align="center" >
	  		  <input type="hidden" name="id" value="${cat.eid}">
	  			<table   style="width:100%; border: none; padding: 10px;">
	  				 <tr>  
	  				   
                      <td>Details:-</td><td><textarea id="elm1" name="area" >${cat.eresdtl}</textarea> <!-- <textarea id="uprice" rows="5" cols="30" placeholder=" Details"></textarea> -->
                      </td>
	  				</tr>

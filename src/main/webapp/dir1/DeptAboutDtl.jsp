		...
		.planeTbl tr:HOVER {
  		...
  		<div  style="border:1px solid #aaa;padding:10px;border-radius:5px;text-align: center">
	  		...
	  		<div class="row">
	  		  <div class="col-sm-12" style="border: 1px solid; margin-left: 15px;width: 95%;" align="center" >
	  			<table   style="width:100%; border: none;">
	  				<tr style="border: none!important;">
	  					...
	  					<%-- <select  required name="did" id="did" required="required" style="width: 100%; height: 40px;"  >
	  				   ...
	  				   <td>
	  				    <input type="text" id="decription"  placeholder="Heading" style="width: 100%; height: 40px;"  >
	  				   </td>
                      ...
                      <td colspan="4">Details:-<textarea id="elm1" name="area" required="required"></textarea> <!-- <textarea id="uprice" rows="5" cols="30" placeholder=" Details"></textarea> -->
                      </td>
	  				</tr>
    	        ...
    	        <form action="DepartmentDetl" method="post"  id="frm" >
			<div class="col-sm-12" style="border: 1px solid; margin-left: 15px;width: 95%;margin-top: 20px;" >
			          <h4>Newly Added Details</h4>
    	                <table id="td1" style="width: 100%;">
					        <thead>
					            <tr>
					                 <th style="color: #fff; background: #002e3b;border:1px solid #003135; ">Sr.No</th>
					                <th style="color: #fff; background: #002e3b;border:1px solid #003135; ">Heading</th>
					    ...
					    <br><br>
                         ...
                         <input type="submit" value="Final Submit" id="btn" > 
                         <br>
            </div>
            </form>
            </div>
						...
						<table style="width: 100%;" >
					        ...
					        <tbody>
					              ...
					              <tr> 
					                  ...
					                  <td>${dtls.heading}</td>
					                  <td>${dtls.details}</td>
					                  <td><a href="DeptAboutDtlDelete?id=${dtls.did}">Delete</a></td>
					                  <c:set var = "string2" value = "${fn:replace(dtls.details, '\\'', '`')}" />
					                  <c:set var = "string2" value = "${fn:replace(string2, '\"', '``')}" />
					                  <td><a href="UpdateDepDtl?id=${dtls.did}">Edit</a></td>

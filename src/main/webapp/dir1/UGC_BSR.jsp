			...
			success:function(data){
				...
				for (var key in data.hm) {
					($('#myTable tbody')).append('<tr >'
						+'<td>'+ ++sno +'</td>'
						+'<td><a href="https://s3.us-east-2.amazonaws.com/rmc-bucket/IQAC/UGC_BSR/'+key+'/'+data.hm[key][0]+'">'+data.hm[key][0]+'</a></td>'
  ...
  <div class="container" style="padding:10px">
	...
	<style>
		...
		.planeTbl tr:HOVER {
  		...
  		<h3 style="line-height: 0px;">UGC-BSR</h3>
  		<br/>
  		...
  		<table id="myTable" class="Vscroll">
  			...
  			<thead id="bottonTh">
  				<tr>
  					<th colspan="2"></th>
  					<th colspan="1">
  						<input type="hidden" name="tblName" value="UGC_BSR"/>

...
<head>
	...
	$( document ).ready(function() {
		...
		if($('#resultUpdate').val() == '1'){
			$("#NoticeUpdateSucc").click();
		}
		if($('#resultDelete').val() == '1'){
			$("#NoticeDeleteSucc").click();
		}
			...
			success:function(data){
				...
				for (var key in data.hm) {
					($('#myTable tbody')).append('<tr >'
						...
						+'<td>'+data.hm[key][1]+'</td>'
						+'<td>'+data.hm[key][2]+'</td>'
						+'<td><a href="'+s3path+'notice/'+key+'/'+data.hm[key][4]+'" target="_blank">'+data.hm[key][4]+'</a></td>'
						+'<td>'+data.hm[key][5]+'</td>'
						+'<td>'+data.hm[key][6]+'</td>'
 						+'<td>'+data.hm[key][8]+'</td>'
 						+'<td>'+data.hm[key][9]+'</td>'
  ...
  <div class="container" style="padding:10px">
	...
	<style>
		...
		.planeTbl tr:HOVER {
  		...
  		<h3 style="line-height: 0px;">Notice Manager</h3>
  		<br/>
  			...
  			<table class="planeTbl" style="width:100%">
  				<tr>
  					...
  					<td width="10%">Notice Title <span class="req">*</span></td>
  				...
  				<tr>
  					<td>Status <span style="font-size: 0.8em">(To view Blink online)</span>  <span class="req">*</span></td>
  					<td>
  		...
  		<table id="myTable" class="Vscroll">
  			<thead>
  				<tr>
  					<th style="color: #fff; background: #002e3b;border:1px solid #003135; ">Notice ID</th>
		        ...
		        <div class="modal-body" style="text-align: center">
		        	...
		        	<table  class="planeTbl" style="width:100%">
		        		<tr>
		        			...
		        			<td width="13%">Notice Title <span class="req">*</span></td>
		  					<td width="37%"><input type="text" class="form-control" name="title" required id="title-modal"/></td>
		        		</tr>
		        		<tr>
		  					<td>Start Date <span class="req">*</span></td>
		  					<td><input type="text" class="form-control"  id="date-modal" name="sdate" required/></td>
		  					<td rowspan="2">Datails</td>
		  				...
		  				<tr>
		  					...
		  					<td>
		  						<select class="form-control" name="status" id="status-modal" required>
		  							<option value="Yes">Yes</option>
		  							<option value="No">No</option>
		  						</select>
		  					</td>
		  					...
		  					<tr>
			  					<td>Status <span style="font-size: 0.8em">(To view Blink online)</span>  <span class="req">*</span></td>
			  					<td>
			  						<select class="form-control" name="active" id="active-modal" required="required">
			  						    <option value="">Choose</option>
			  							<option value="Yes">Yes</option>
			  							<option value="No">No</option>
			  						</select>
...
<!-- 		        </div> -->
		...
		<button type="button" id="NoticeCrSucc" style="display:none" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal-success">Open Large Modal</button>
		      ...
		      <div class="modal-content">
		        <div class="modal-body" style="text-align: center">
					<br/><br/>
		          	...
		          	<h3 style="color:green">Notice created successfully</h3>
		  ...
		  <button type="button" id="NoticeUpdateSucc" style="display:none" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal-success-update">Open Large Modal</button>
		      ...
		      <div class="modal-content">
		        <div class="modal-body" style="text-align: center">
					<br/><br/>
		          	...
		          	<h3 style="color:green">Notice updated successfully</h3>
		  ...
		  <button type="button" id="NoticeDeleteSucc" style="display:none" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal-success-delete">Open Large Modal</button>
		      ...
		      <div class="modal-content">
		        <div class="modal-body" style="text-align: center">
					<br/><br/>
		          	...
		          	<h3 style="color:green">Notice deleted successfully</h3>

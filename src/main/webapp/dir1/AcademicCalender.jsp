			...
			success:function(data){
				...
				for (var key in data.hm) {
					($('#myTable tbody')).append('<tr >'
						+'<td>'+ ++sno+'</td>'
						+'<td>'+data.hm[key][0]+'</td>'
						+'<td><a href="'+s3path+'academic_calender/'+key+'/'+data.hm[key][1]+'" target="_blank">'+data.hm[key][1]+'</a></td>'
  ...
  <div class="container" style="padding:10px">
	...
	<style>
		...
		.planeTbl tr:HOVER {
  		...
  		<h3 style="line-height: 0px;">Academic Calendar Manager</h3>
  		<br/>
  		...
  		<br/>
  		<b>Already created Academic Calenders:</b>
  		<style>
  			#bottonTh th{
  		...
  		<form action="DeleteAcademicCalender" method="post">
		    ...
		    <div class="modal-dialog modal-lg ">
		      <div class="modal-content">
		        <div class="modal-header">
		          ...
		          <h4 class="modal-title">Edit Academic Calender</h4>
		        </div>
		        <div class="modal-body" style="text-align: center">
					<form action="UpdateAcademicCalender" method="post"  enctype="multipart/form-data" onsubmit="return chkPDF1()">
		        	<table  class="planeTbl" style="width:100%">
		        		<tr>

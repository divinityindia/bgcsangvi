...
<script type="text/javascript" src="../js/piechart/femployeremployeereport.js"></script>
  ...
  <div class="container" style="padding:10px auto;">
       				...
       				<div id="block1">
						...
						<center>
								...
								<h3>Employer - Feedback About Student</h3>
								<button id="printBtn" type="button">PRINT</button><br/>
									...
									<table class="info" id="chartTbl" style="border-collapse: collapse;">
										...
										<tr>
											<th style="font-size: small;font-weight: bold;"><br/>Employer - Feedback About Student- Total: ${total}</th>
										</tr>
										</thead>
										<tbody>
										<tr>
									...
									<table id="detailTbl" style="border-collapse: collapse;width: 100%">
										<thead>
											<tr style="background: #f1f9ec">
												...
												<th style="font-weight: bold;border: 1px solid #000000;text-align: center;">Company Name</th>
												<th style="font-weight: bold;border: 1px solid #000000;text-align: center;">Address</th>
												<th style="font-weight: bold;border: 1px solid #000000;text-align: center;">Contact</th>
												<th style="font-weight: bold;border: 1px solid #000000;text-align: center;">Name &amp; Designation</th>
												<th style="font-weight: bold;border: 1px solid #000000;text-align: center;">Email</th>
											</tr>
										</thead>
										<tbody>
											<c:forEach var="cat" items="${edtls}" varStatus="row">
												<tr onmouseover="this.style.backgroundColor='#ffff66';" onmouseout="this.style.backgroundColor='#f1f9ec';" style="background: #f1f9ec">
													...
													<td style="border: 1px solid #000000;text-align: justify;padding:2px 5px 2px 5px;">${cat.companyname}</td>
													<td style="border: 1px solid #000000;text-align: justify;">${cat.address}</td>
													<td style="border: 1px solid #000000;text-align: center;padding:2px 5px 2px 5px;">${cat.contact}</td>
													<td style="border: 1px solid #000000;text-align: justify;padding:2px 5px 2px 5px;">${cat.namedesig}</td>
													<td style="border: 1px solid #000000;text-align: justify;padding:2px 5px 2px 5px;">${cat.eml}</td>
												</tr>
											</c:forEach>
										</tbody>
									</table>

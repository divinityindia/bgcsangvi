	...
	<style>
		...
		.planeTbl tr:HOVER {
  		...
  		<div  style="border:1px solid #aaa;padding:10px;border-radius:5px;text-align: center">
	  		...
	  		<form action="deptreserch" method="post"  enctype="multipart/form-data" onsubmit="return chkPDF()">
  			...
  			<thead>
  				...
  				<c:forEach var="cat" varStatus="row" items="${det}">
  				 <tr>
  				     ...
  				     <td>${cat.title }</td>
  				     <td>${cat.detalis }</td>
  				     <td><a href="https://s3.us-east-2.amazonaws.com/test-rmc-bucket/AddDepRes/${cat.deptid}_${cat.document}">${cat.document}</a></td>
  				     <td><a href="DeptStaffresearchDelete?id=${cat.srid}">Delete</a></td>
		    ...
		    <div class="modal-dialog modal-lg ">
		      <div class="modal-content">
		        <div class="modal-header">
		          ...
		          <h4 class="modal-title">Edit Department Research</h4>
		        </div>
		        <div class="modal-body" style="text-align: center">
	  			...
	  			function chkPDF2(){
					...
					<form action="DeptReserchUpdate" method="post"  enctype="multipart/form-data" onsubmit="return chkPDF2()">
		        	<table  class="planeTbl" style="width:100%">

  ...
  <div class="container" style="padding:10px">
	...
	<style>
		...
		.planeTbl tr:HOVER {
  		...
  		<h3 style="line-height: 0px;">Add IQAC Committee</h3>
  		<br/>
  		     <script>
	  		function chkPDF(){
  				var f=$('#f1').val();
  			...
  			<form action="IQACCommitteeController" method="post" enctype="multipart/form-data" onsubmit="return chkPDF()">
  		...
  		<br/>
  		<b>Already Added IQAC Committees</b>
  		<style>
  			#bottonTh th{
  		...
  		<table id="myTable" class="Vscroll">
  			...
  			<c:forEach var="cat" items="${dtl}" varStatus="row">
  				<tr>
  				     <td>${row.count}</td>
  				     <td>${cat.title}</td>
  				     <td><a href="${s3path}IQACCommittee/${cat.acid}_${cat.document}" target="_blank">${cat.document}</a></td>
  				     <td><a href="DeleteIQACCommittee?id=${cat.acid}">Delete</a></td>
  				</tr>
  			</c:forEach>

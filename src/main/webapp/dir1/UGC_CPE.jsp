			...
			success:function(data){
				...
				for (var key in data.hm) {
					($('#myTable tbody')).append('<tr >'
						+'<td>'+ ++sno +'</td>'
// 						+'<td>'+data.hm[key][0]+'</td>'
						+'<td><a href="https://s3.us-east-2.amazonaws.com/rmc-bucket/IQAC/UGC_CPE/'+key+'/'+data.hm[key][0]+'">'+data.hm[key][0]+'</a></td>'
  ...
  <div class="container" style="padding:10px">
	...
	<style>
		...
		.planeTbl tr:HOVER {
  		...
  		<div style="border:1px solid #aaa;padding:10px;border-radius:5px;text-align: center;width:70%;margin: auto">
  		<h3 style="line-height: 0px;">UGC_CPE</h3>
  		<br/>
  			...
  			<table class="planeTbl" style="width:100%">
  				...
  				<tr>
  				     <td>
  				       Document Heading:-<span class="req">*</span>
  				   </td>
  				   <td>
  						<input type="text"  name="dhead" required/>
  					</td>
  				   <td>
  		...
  		<table id="myTable" class="Vscroll">
  			...
  			<thead id="bottonTh">
  				<tr>
  					<th colspan="2"></th>
  					<th colspan="1">
  						<input type="hidden" name="tblName" value="UGC_CPE"/>

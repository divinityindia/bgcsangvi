  ...
  <div class="container" style="padding:10px">
	...
	<style>
		...
		.planeTbl tr:HOVER {
  		...
  		<h3 style="line-height: 0px;">Add Admission Document</h3>
  		<br/>
  			<form action="AddAdmission" method="post" enctype="multipart/form-data" onsubmit="return chkPDF()">
  			...
  			<table class="planeTbl" style="width:100%">
  				<tr>
  					...
  					<td width="40%"><select class="form-control" name="title" required>
  					                 ...
  					                 <option>Reservation Policy</option>
  		...
  		<br/>
  		<b>Already Added Admission Document:</b>
  		<style>
  			#bottonTh th{
  		...
  		<table id="myTable" class="Vscroll">
  			...
  			<c:forEach var="cat" items="${dtl}" varStatus="row">
  				<tr>
  				     <td>${row.count}</td>
  				     <td>${cat.dpmenu}</td>
  				     <td><a href="${s3path}AddAdmission/${cat.adid}_${cat.document}" target="_blank">${cat.document}</a></td>
  				     <td><a href="DeleteAddAdmission?id=${cat.adid}">Delete</a></td>
  				</tr>
  			</c:forEach>

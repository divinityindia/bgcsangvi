	...
	<style>
		...
		.planeTbl tr:HOVER {
  		...
  		<div  style="border:1px solid #aaa;padding:10px;border-radius:5px;text-align: center">
	  		...
	  		<h3>Add Research Center Areas</h3>
	  		<br/>
		...
		<c:remove var="erMsg"/>
	  		<div class="row">
	  		<form action="ResearchCenterAreasController" method="post"  id="frm" >
            ...
            <br><br>
                       ...
                       <h3>Already  Added Research Center Areas</h3>   
					        ...
					        <tbody>
					              ...
					              <tr> 
					                  ...
					                  <td style="text-align: left">${dtls.detls}</td>
					                   <td><a href="DeleteResearchCenterDetails?id=${dtls.rcid}&tab=RC_areas">Delete</a></td>

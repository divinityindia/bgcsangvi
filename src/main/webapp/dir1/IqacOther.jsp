			...
			success:function(data){
				...
				for (var key in data.hm1) {
					($('#myTable tbody')).append('<tr >'
						+'<td>'+ ++sno +'</td>'
// 						+'<td>'+data.hm[key][0]+'</td>'
						+'<td><a href="'+s3path+'IQAC/IqacOther/'+key+'/'+data.hm1[key][0]+'" target="_blank">'+data.hm1[key][0]+'</a></td>'
  ...
  <div class="container" style="padding:10px">
	...
	<style>
		...
		.planeTbl tr:HOVER {
  		...
  		<h3 style="line-height: 0px;">Other</h3>
  		<br/>
  		...
  		<table id="myTable" class="Vscroll">
  			...
  			<thead id="bottonTh">
  				<tr>
  					<th colspan="2"></th>
  					<th colspan="1">
  						<input type="hidden" name="tblName" value="IqacOther"/>

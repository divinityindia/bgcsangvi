  ...
  <div class="container" style="padding:10px">
	...
	<style>
		...
		.planeTbl tr:HOVER {
  		...
  		<h3 style="line-height: 0px;">Add Student Satisfaction Survey Report</h3>
  		<br/>
  		     <script>
	  		function chkPDF(){
  				var f=$('#f1').val();
  			...
  			<form action="StudentSatisfactionSurvey" method="post" enctype="multipart/form-data" onsubmit="return chkPDF()">

  			<table class="planeTbl" style="width:100%">
  				<tr>

  					<td width="10%">Report Title:- <span class="req">*</span></td>
  					<td width="40%"><input type="text" name="title" class="form-control" placeholder="Ex. :- Student Satisfaction Survey Report 2018-19">
  					</td>
  		...
  		<br/>
  		<b>Already Added Student Satisfaction Survey Reports</b>
  		<style>
  			#bottonTh th{
  		...
  		<table id="myTable" class="Vscroll">
  			...
  			<c:forEach var="cat" items="${dtl}" varStatus="row">
  				<tr>
  				     <td>${row.count}</td>
  				     <td>${cat.title}</td>
  				     <td><a href="${s3path}StudentSatisfactionSurvey/${cat.fbid}_${cat.filename}" target="_blank">${cat.filename}</a></td>
  				     <td><a href="DeleteStudentSatisfactionSurvey?id=${cat.fbid}">Delete</a></td>
		    ...
		    <div class="modal-dialog modal-lg ">
		      <div class="modal-content">
		        <div class="modal-header">
		          ...
		          <h4 class="modal-title">Edit Student Satisfaction Survey Report</h4>
		        </div>
		        <div class="modal-body" style="text-align: center">
					<form action="UpdateStudentSatisfactionSurvey" method="post" enctype="multipart/form-data" onsubmit="return chkPDF1()">

  ...
  <div class="container" style="padding:10px">
	...
	<style>
		...
		.planeTbl tr:HOVER {
  		...
  		<h3 style="line-height: 0px;">Add Academic Calendar</h3>
  		<br/>
  		     <script>
	  		function chkPDF(){
  				var f=$('#f1').val();
  			...
  			<form action="AcedemicCalenderController" method="post" enctype="multipart/form-data" onsubmit="return chkPDF()">
  		...
  		<br/>
  		<b>Already Added Academic Calendar</b>
  		<style>
  			#bottonTh th{
  		...
  		<table id="myTable" class="Vscroll">
  			...
  			<c:forEach var="cat" items="${dtl}" varStatus="row">
  				<tr>
  				     <td>${row.count}</td>
  				     <td>${cat.title}</td>
  				     <td><a href="${s3path}AcedemicCalenderes/${cat.acid}_${cat.document}" target="_blank">${cat.document}</a></td>
  				     <td><a href="DeleteAcedemicCalenderes?id=${cat.acid}">Delete</a></td>
  				</tr>
  			</c:forEach>
		      ...
		      <div class="modal-content">
		        <div class="modal-body" style="text-align: center">
					<br/><br/>
		          	...
		          	<h3 style="color:green">New Academic Calendar Created successfully</h3>
		      ...
		      <div class="modal-content">
		        <div class="modal-body" style="text-align: center">
					<br/><br/>
		          	...
		          	<h3 style="color:green">Academic Calendar updated successfully</h3>
		      ...
		      <div class="modal-content">
		        <div class="modal-body" style="text-align: center">
					<br/><br/>
		          	...
		          	<h3 style="color:green">Academic Calendar deleted successfully</h3>

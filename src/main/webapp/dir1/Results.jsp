...
<head>
			...
			success:function(data){
				...
				for (var key in data.hm) {
					($('#myTable tbody')).append('<tr >'
						...
						+'<td>'+data.hm[key][1]+'</td>'
						+'<td>'+data.hm[key][2]+'</td>'
						+'<td><a href="'+s3path+'results/'+key+'/'+data.hm[key][3]+'" target="_blank">'+data.hm[key][3]+'</a></td>'
	...
	<script>
		function puValsInModel(RID, year, pattern, exam){
			$("#rid-modal").val(RID);
			$("#year-modal").val(year);
  ...
  <div class="container" style="padding:10px">
	...
	<style>
		...
		.planeTbl tr:HOVER {
  		...
  		<h3 style="line-height: 0px;">Result Manager</h3>
  		<br/>
  			<form action="" method="post" enctype="multipart/form-data" onsubmit="return chkPDF()">

  			<table class="planeTbl" style="width:100%">
  				<tr>
  					<td width="15%">Year <span class="req">*</span></td>
  					<td width="35%">
						<input type="text" class="form-control" name="year" required placeholder="e.g. F.Y."/>
  					</td>
  					<td width="10%">Pattern <span class="req">*</span></td>
  					<td width="40%"><input type="text" class="form-control" name="pattern" required placeholder="e.g. 2012 Pattern"/></td>
  				</tr>
  				<tr>
  					<td>Examination <span class="req">*</span></td>
  					<td><input type="text" class="form-control" name="exam" required placeholder="Exam Name"/></td>
  					<td>Upload Document <span class="req">*</span></td>
  					<td><input type="file"  name="file" id="f1" required/></td>
  				</tr>
  		...
  		<table id="myTable" class="Vscroll">
  			<thead>
  				<tr>
  					...
  					<th style="color: #fff; background: #002e3b;border:1px solid #003135; ">Examination</th>
		    ...
		    <div class="modal-dialog modal-lg ">
		      <div class="modal-content">
		        ...
		        <div class="modal-body" style="text-align: center">
					<form action="UpdateResults" method="post"  enctype="multipart/form-data" onsubmit="return chkPDF1()">
		        	<table  class="planeTbl" style="width:100%">
		        		<tr>
		  					<td width="15%">Year <span class="req">*</span></td>
		  					<td width="35%">
								<input type="text" class="form-control" name="year" id="year-modal" required placeholder="e.g. F.Y."/>
		  					</td>
		  					<td width="10%">Pattern <span class="req">*</span></td>
		  					<td width="40%"><input type="text" class="form-control" name="pattern" id="pattern-modal" required placeholder="e.g. 2012 Pattern"/></td>
		  				</tr>
		  				<tr>
		  					<td>Examination <span class="req">*</span></td>
		  					<td><input type="text" class="form-control" name="exam" id="exam-modal" required placeholder="Exam Name"/></td>
		  					<td>Upload Document <span class="req">*</span></td>
		  					<td><input type="file"  name="file" id="f2" required/></td>
		  				</tr>
		  				<tr>
		  					<td></td>
		  					<td>
		  						<input type="hidden" name="RID" id="rid-modal"/>
		      ...
		      <div class="modal-content">
		        <div class="modal-body" style="text-align: center">
					<br/><br/>
		          	...
		          	<h3 style="color:green">Result created successfully</h3>
		      ...
		      <div class="modal-content">
		        <div class="modal-body" style="text-align: center">
					<br/><br/>
		          	...
		          	<h3 style="color:green">Result(s) updated successfully</h3>
		      ...
		      <div class="modal-content">
		        <div class="modal-body" style="text-align: center">
					<br/><br/>
		          	...
		          	<h3 style="color:green">Result(s)deleted successfully</h3>

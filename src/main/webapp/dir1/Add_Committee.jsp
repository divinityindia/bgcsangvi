...
<!-- <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.0/jquery.min.js"></script> -->
<script>
		function puValsInModel(cmid,name){
// 			alert(cmid+' '+name);
			$("#cmmid").val(cmid);
			$("#cpnm").val(name);
		}
...
<%-- 			<jsp:include page="header.jsp"></jsp:include> --%>
  ...
  <div class="container" style="padding:10px">
	...
	<style>
		...
		<c:remove var="erMsg"/>
	  		<div class="row">
	  		<form action="Add_CommitteeController" method="post"  id="frm" >
	  			...
	  			<table   style="width:100%; border: none; padding: 10px;">
	  				...
	  				<tr style="border: none!important;">
	  					...
	  					<td style="border: none;">
  						 <input type="text"  required name="caption" id="did" required="required" style="width: 80%; height: 40px;"  >
  						</td>
  					</tr>
            ...
            <br><br>
				...
				<div style="width: 100%;height: 400px;overflow: scroll;">
						<table style="width: 100%;" >
					        ...
					        <tbody>
					              <c:forEach var="dtls" items="${cmtdtl}" varStatus="row">
					              <tr> 
					                  <td>${row.count}</td>
					                  <td style="text-align: left">${dtls.comtname}</td>
					                   <td><a href="Edit_CommitteeController?cmid=${dtls.cmid}">Delete</a></td>
					                   <td><input type="button" onclick="puValsInModel(${dtls.cmid},'${dtls.comtname}')" value="  Edit  " class="green-btn" data-toggle="modal" data-target="#myModal"/></td>
					              </tr>
					            </c:forEach>
					        </tbody>
					    </table>
		    ...
		    <div class="modal-dialog modal-lg " >
		      <div class="modal-content"  style="height: 200px;;">
		        ...
		        <div class="modal-body" style="text-align: center;height: auto;">
					<form action="Edit_CommitteeController" method="post"  id="frm" >
	  		  <div class="col-sm-12" style="border: 1px solid; margin-left: 15px;width: 95%;" align="center" >
	  			<table   style="width:100%; border: none; padding: 10px;">
	  				...
	  				<tr style="border: none!important;">
	  					...
	  					<td  style="border: none!important;">
  						 <input type="text"   name="caption" id="cpnm" required="required" style="width: 80%; height: 40px;"  >
  						</td>
  					</tr>
	  			
	  			</table>
	  			<br>
	  			       <input type="hidden" name="cmid" id="cmmid">
    	               <input type="submit"  value="Submit">
    	               <br>
    	  	</div>    

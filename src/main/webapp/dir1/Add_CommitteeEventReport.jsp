  ...
  <div class="container" style="padding:10px">
	...
	<style>
		...
		.planeTbl tr:HOVER {
  		...
  		<h3 style="line-height: 0px;">Add Committee Event Report</h3>
  		<br/>
		...
		<c:remove var="erMsg"/>
  			<form action="Add_CommitteeEventReportController" method="post" enctype="multipart/form-data" onsubmit="return chkPDF()">
...
<!--   					                 <option>~~ Choose Event ~~</option> -->
  		...
  		<br/>
  		<b>Already Added Committee Event Reports :</b>
  		<style>
  			#bottonTh th{
  		...
  		<table id="myTable" class="Vscroll">
  			...
  			<c:forEach var="cat" items="${cerdtl}" varStatus="row">
  				<tr>
  				     ...
  				     <td>${cat.comtname}</td>
  				     <td>${cat.evntname}</td>
  				     <td><a href="${s3path}AddCommitteeEventReport/${cat.rpid}_${cat.rdocument}" target="_blank">${cat.rdocument}</a></td>
  				     <td><a href="Delete_CommitteeEventReportController?id=${cat.rpid}&tab=Report">Delete</a></td>
  				</tr>
  			</c:forEach>

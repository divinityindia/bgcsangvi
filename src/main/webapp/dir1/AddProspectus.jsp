  ...
  <div class="container" style="padding:10px">
	...
	<style>
		...
		.planeTbl tr:HOVER {
  		...
  		<h3 style="line-height: 0px;">Add Prospectus</h3>
  		<br/>
  		     <script>
	  		function chkPDF(){
  				var f=$('#f1').val();
  			...
  			<form action="ProspectusController" method="post" enctype="multipart/form-data" onsubmit="return chkPDF()">
  		...
  		<table id="myTable" class="Vscroll">
  			...
  			<tbody>
  				<tr>
  				     <td>1</td>
  				     <td>${dtl.title}</td>
  				     <td><a href="${s3path}Prospectus/${dtl.pbid}_${dtl.document}" target="_blank">${dtl.document}</a></td>
  				</tr>

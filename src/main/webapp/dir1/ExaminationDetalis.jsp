	...
	<style>
		...
		.planeTbl tr:HOVER {
  		...
  		<div  style="border:1px solid #aaa;padding:10px;border-radius:5px;text-align: center">
	  		...
	  		<h3>Add Examination Committee</h3>
	  		<br/>
	  		
	  		<div class="row">
	  		<form action="ExaminationDetalis" method="post"  id="frm" >
	  		  <div class="col-sm-12" style="border: 1px solid; margin-left: 15px;width: 95%;" align="center" >
	  		  <input type="hidden" name="id" value="${cat.exdid}">
	  			<table   style="width:100%; border: none; padding: 10px;">
	  				 <tr>  
	  				   
                      <td>Details:-</td><td><textarea id="elm1" name="area" >${cat.exedetails}</textarea> <!-- <textarea id="uprice" rows="5" cols="30" placeholder=" Details"></textarea> -->
                      </td>
	  				</tr>

...
<script type="text/javascript" src="../js/piechart/fstudentcollegereport.js"></script>
			...
			<!-- Q1 -->
       				...
       				<div id="block1">
						...
						<center>
								...
								<h3>Student - About College Feedback</h3>
								<button id="printBtn" type="button">PRINT</button><br/>
									<br/>
									<div id="printBlock">
									<table class="info" id="chartTbl" style="border-collapse: collapse;width:100%">
										<thead>
										<tr>
											<th style="font-size: medium;font-weight: bold;">${feedback.name} - ${feedback.duration}</th>
										</tr>
										<tr>
											<th style="font-size: small;font-weight: bold;"><br/>Student - About College Feedback - Total: ${total}</th>
										</tr>
										</thead>
										<tbody>
										<tr>
									...
									<table id="detailTbl" style="border-collapse: collapse;width: 100%">
										<thead>
											<tr style="background: #f1f9ec">
												...
												<th style="font-weight: bold;border: 1px solid #000000;text-align: center;width: 15%">Degree</th>
												<th style="font-weight: bold;border: 1px solid #000000;text-align: center;width: 15%">Course</th>
												<th style="font-weight: bold;border: 1px solid #000000;text-align: center;width: 15%">Gender</th>
												<th style="font-weight: bold;border: 1px solid #000000;text-align: center;width: 15%">Age</th>
										...
										<tbody>
											<c:forEach var="cat" items="${list}" varStatus="row">
												<tr onmouseover="this.style.backgroundColor='#ffff66';" onmouseout="this.style.backgroundColor='#f1f9ec';" style="background: #f1f9ec">
													...
													<td style="border: 1px solid #000000;text-align: left;">${cat.deg}</td>
													<td style="border: 1px solid #000000;text-align: left;">${cat.course}</td>
													<td style="border: 1px solid #000000;text-align: left;">${cat.gender}</td>
													<td style="border: 1px solid #000000;text-align: left;">${cat.age}</td>

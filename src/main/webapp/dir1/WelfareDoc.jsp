...
<head>
			...
			success:function(data){
				...
				for (var key in data.hm) {
					($('#myTable tbody')).append('<tr >'
						+'<td>'+ ++sno +'</td>'
						+'<td>'+data.hm[key][0]+'</td>'
						+'<td><a href="'+s3path+'welfare_docs/'+key+'/'+data.hm[key][1]+'" target="_blank">'+data.hm[key][1]+'</a></td>'
	...
	<script>
		function puValsInModel(WID, info){
			$("#wid-modal").val(WID);
			$("#info-modal").val(info);
		}
		...
		.planeTbl tr:HOVER {
  		...
  		<br/>
  			...
  			<table class="planeTbl" style="width:100%">
  				...
  				<tr>
  					<td>Information to show <span class="req">*</span></td>
  					<td><input type="text" class="form-control" name="info" required placeholder="Information to show studernt"/></td>
  		...
  		<form action="DeleteWelfareDocs" method="post">
  		<table id="myTable" class="Vscroll">
  			<thead>
  				<tr>
  					<th style="color: #fff; background: #002e3b;border:1px solid #003135; ">Sr. No.</th>
  					<th style="color: #fff; background: #002e3b;border:1px solid #003135; ">Information</th>
		    ...
		    <div class="modal-dialog modal-lg ">
		      <div class="modal-content">
		        <div class="modal-header">
		          ...
		          <h4 class="modal-title">Edit Welfare Document</h4>
		        </div>
		        <div class="modal-body" style="text-align: center">
					<form action="UpdateWelfareDocs" method="post" enctype="multipart/form-data">
		        	<table  class="planeTbl" style="width:100%">
		        		<tr>
		  					<td>Information to show <span class="req">*</span></td>
		  					<td><input type="text" class="form-control" name="info" id="info-modal" required placeholder="Information to show studernt"/></td>
		  					<td>Upload Document <span class="req">*</span></td>
		  					<td>
		  						<input type="file"  name="file" required/>
		  					</td>
		  				...
		  				<tr>
		  					...
		  					<td>
		  						<input type="hidden" name="WID" id="wid-modal"/>

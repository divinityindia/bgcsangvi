...
<head>
	...
	<script type="text/javascript" src="../js/piechart/fstudentteachingreport.js"></script>
...
<%--        				<input type="hidden" id="q12a5" value="${q12a5}"> --%>
       				...
       				<div id="block1">
						...
						<center>
								...
								<h3>Student - Feedback About Teachers </h3>
								<button id="printBtn" type="button">PRINT</button><br/>
									...
									<table class="info" id="chartTbl" style="border-collapse: collapse;">
										...
										<tr>
											<th style="font-size: small;font-weight: bold;"><br/>Student - Feedback About Teachers - Total: ${total}</th>
										</tr>
										</thead>
										<tbody>
										<tr>
...
<!-- 												<th style="font-weight: bold;border: 1px solid #000000;text-align: center;width: 25%">Course</th> -->
<!-- 												<th style="font-weight: bold;border: 1px solid #000000;text-align: center;width: 15%">Academic Year</th> -->

$(document).ready(function(){
	...
	$("#otherqual").click(function(){
		if($("#otherqual").text()=="Other Qualification")
		{
			$("#otherqual").text("Cancel");
			$("#odegree").attr({"required" : true, "disabled" : false});
			$("#ospl").attr({"required" : true, "disabled" : false});
			$("#oinst").attr({"required" : true, "disabled" : false});
			$("#ouniv").attr({"required" : true, "disabled" : false});
			$("#opyr").attr({"required" : true, "disabled" : false});
			$("#oper").attr({"required" : true, "disabled" : false});
		}
		else
		{
			$("#odegree").prop("selectedIndex", 0)
			$("#otherqual").text("Other Qualification");
			$("#odegree").attr({"required" : false, "disabled" : true});
			$("#ospl").attr({"required" : false, "disabled" : true});
			$("#oinst").attr({"required" : false, "disabled" : true});
			$("#ouniv").attr({"required" : false, "disabled" : true});
			$("#opyr").attr({"required" : false, "disabled" : true});
			$("#oper").attr({"required" : false, "disabled" : true});
		}
		$("#otq").toggle();
		
	});
	
	$("#odegree").change(function(){
		if($("#odegree").val()=="Illiterate"){
			$("#ospl").attr({"required" : false, "disabled" : true});
			$("#oinst").attr({"required" : false, "disabled" : true});
			$("#ouniv").attr({"required" : false, "disabled" : true});
			$("#opyr").attr({"required" : false, "disabled" : true});

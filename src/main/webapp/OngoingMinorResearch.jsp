								...
								<div class="tg-widget tg-widgetaboutusnav">
									...
									<hr style="border: 1px solid black;">
										<ul class="listul" >
											...
											<a href="OngoingMinorResearch.jsp"><li class="des active" style="font-size: 13px;">Ongoing Minor Research Project</li></a>
						...
						<div id="container1">
						  <div id="container2" ><br>
                             <table  width="100%">
										...
										<th style="color: #003135; background: #fdd991;border:1px solid #003135; padding: 12px;">Department</th>
										<th style="color: #003135; background: #fdd991;border:1px solid #003135; padding: 12px;">Funding Agency</th>
										<th style="color: #003135; background: #fdd991;border:1px solid #003135; padding: 12px;">Duration</th>
										<th style="color: #003135; background: #fdd991;border:1px solid #003135; padding: 12px;">Amount Sanction (Rs.)</th>
										</tr>
										<tr height="20">
										<td style="padding: 10px;">1</td>
										<td style="padding: 10px;">Dr P.B.Cholke</td>
										<td style="padding: 10px;">Botany</td>
										<td style="padding: 10px;">UGC</td>
										<td style="padding: 10px;">Two year</td>
										<td style="padding: 10px;">45,000</td>
										</tr>
										<tr height="20">
										<td style="padding: 10px;">2</td>
										<td style="padding: 10px;">Dr.T.N.Salve</td>
										<td style="padding: 10px;">Economics</td>
										<td style="padding: 10px;">BCUD</td>
										<td style="padding: 10px;">Two year</td>
										<td style="padding: 10px;">1,10,000</td>
										</tr>
										<tr height="20">
										<td style="padding: 10px;">3</td>
										<td style="padding: 10px;">Dr.S.A.Singh</td>
										...
										<td style="padding: 10px;">DrR.V.Kshirsagar</td>
										<td style="padding: 10px;">Zoology</td>
										<td style="padding: 10px;">UGC</td>
										<td style="padding: 10px;">Two year</td>
										<td style="padding: 10px;">95,000</td>
										</tr>
										<tr height="20">
										<td style="padding: 10px;">5</td>
										<td style="padding: 10px;">Dr. Ganpule S.P.</td>
										<td style="padding: 10px;">English</td>
										<td style="padding: 10px;">UGC</td>
										<td style="padding: 10px;">Two year</td>
										<td style="padding: 10px;">101000</td>
										</tr>
										<tr height="20">
										...
										<td style="padding: 10px;">UGC</td>
										<td style="padding: 10px;">Two year</td>
										<td style="padding: 10px;">105000</td>
										</tr>
										<tr height="20">
										<td style="padding: 10px;">7</td>
										<td style="padding: 10px;">Prof. Satav G.P</td>
										...
										<td style="padding: 10px;">UGC</td>
										<td style="padding: 10px;">Two year</td>
										<td style="padding: 10px;">145000</td>
										</tr>
										<tr height="20">
										<td style="padding: 10px;">9</td>
										<td style="padding: 10px;">Prof. Kotkar D P</td>
										<td style="padding: 10px;">Commerce</td>
										<td style="padding: 10px;">BCUD</td>
										<td style="padding: 10px;">Two year</td>
										<td style="padding: 10px;">50000</td>
										...
										<td style="padding: 10px;">Dr. More R.A</td>
										<td style="padding: 10px;">Zoology</td>
										<td style="padding: 10px;">UGC</td>
										<td style="padding: 10px;">Two year</td>
										<td style="padding: 10px;">160000</td>
										</tr>
										<tr height="20">
										<td style="padding: 10px;">11</td>
										<td style="padding: 10px;">Prof. Bansod Vaishali</td>
										<td style="padding: 10px;">Botany</td>
										<td style="padding: 10px;">UGC</td>
										<td style="padding: 10px;">Two year</td>
										<td style="padding: 10px;">55000</td>
										</tr>
										<tr height="20">
										<td style="padding: 10px;">12</td>
										<td style="padding: 10px;">Dr. Kulkarni Savita</td>
										<td style="padding: 10px;">Geography</td>
										<td style="padding: 10px;">BCUD</td>
										<td style="padding: 10px;">Two year</td>
										<td style="padding: 10px;">75,000</td>
										</tr>
										...
										<td style="padding: 10px;">956,000</td>
										</tr>

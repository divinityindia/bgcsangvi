								...
								<div class="tg-widget tg-widgetaboutusnav">
									...
									<hr style="border: 1px solid black;">
										<ul class="listul" >
											...
											<a href="ResearchCommittee.jsp"><li class="des active" style="font-size: 13px;">Research Committee</li></a>
						...
						<div id="container1">
						  <div id="container2" ><br><br>
						          <ul style="margin-left:10%; list-style-type: square; font-size: 15px;">
						              <li style="font-size: 15px;font-weight: bold;">Chairman<br>
						          ...
						          <br>
						           <ul style="margin-left:10%; list-style-type: square; font-size: 15px;">
						              <li style="font-size: 15px;font-weight: bold;">Coordinator<br>
						                   <ul style="margin-left:5%;list-style-type: square;font-weight: normal;">
						                       <li>Head Economics Department</li>
						                   </ul>
						              </li>
						          </ul> 
						           <br>
						           <ul style="margin-left:10%; list-style-type: square; font-size: 15px;">
						              <li style="font-size: 15px;font-weight: bold;">Member<br>
						                   <ul style="margin-left:5%;list-style-type: square;font-weight: normal;">
						                       <li>P.G In Charge Botany Department</li>
						                        <li>Head Hindi Department</li>
						                         <li>Head Geography Department</li>
						                          <li>P.G. In charge Zoology Department</li>
						                   </ul>
						              </li>
						          </ul> 

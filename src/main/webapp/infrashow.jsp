...
<body>
  ...
  <div class="container" style="padding:10px;">
		...
		<div style="text-align: center">
			<h4 style="color:brown">Infra. & Facility Images</h4>
		</div>
		...
		<div class="outerDiv">
		<c:forEach var="rec" items="${dtl}">
			<div class="imgDiv">
				<a class='highslide' href='${s3pat}Infrapic/${rec.imgid}_${rec.image}' onclick="return hs.expand(this)"> 
				<img src='${s3pat}Infrapic/${rec.imgid}_${rec.image}' alt='Mountain valley'/></a>
			</div>
		</c:forEach>
		</div>
		</div>

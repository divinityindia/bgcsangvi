			...
			success:function(data){
				...
				for (var key in data.hm) {
					($('#myTableQPapers tbody')).append('<tr >'
						...
						+'<td>'+data.hm[key][4]+'</td>'
						+'<td>'+data.hm[key][5]+'</td>'
						+'<td><a href="'+s3pat+'qpapers/'+key+'/'+data.hm[key][6]+'" target="_blank">'+data.hm[key][6]+'</a></td>'
						+'</tr>');
		        }
			},
			error:function(data){}
							...
							<aside id="tg-sidebar" class="tg-sidebar">
								<div class="tg-widget tg-widgetaboutusnav">
									...
									<hr style="border: 1px solid black;">
										<ul class="listul" >
											<a href="ProgramOutcomes.jsp" ><li class=" des">Course Outcome / Program Outcome</li></a>
											<a href="Syllabus.jsp"><li class="des">Syllabus</li></a>
											<a href="OldQuestionPapers.jsp"><li class="des active">Old Question Papers</li></a>
											<a href="Result.jsp"><li class="des">Results</li></a>
											<a href="EligibilityNumbers.jsp"><li class="des">Eligibility Numbers</li></a>
											<a href="CyberSecurity.jsp"><li class="des">Cyber Security</li></a>
										</ul>
									</div>
								</div>
							</aside>
										...
										<table id="myTableQPapers" class="Vscroll" style="height: 600px;">
								  			<thead>
								  				<tr>
								  					...
								  					<th style="color: #003135; background: #fdd991;border:1px solid #003135; ">Department </th>
								  					<th style="color: #003135; background: #fdd991;border:1px solid #003135; ">Year</th>
								  					<th style="color: #003135; background: #fdd991;border:1px solid #003135; ">Pattern</th>
								  					<th style="color: #003135; background: #fdd991;border:1px solid #003135; ">Subject</th>
								  					<th style="color: #003135; background: #fdd991;border:1px solid #003135; ">Exam</th>

								...
								<div class="tg-widget tg-widgetaboutusnav">
									...
									<hr>
										<ul class="listul" >
											...
											<a href="StudentDevelopment?type=Cultural Activity&pgnm=StudentDevelopmentCulturalActivity"><li class="des active" style="font-size: 13px;">Cultural Activity</li></a>
...
<!-- 											<a href="InternalComplianceCommittees.jsp"><li class="des" style="font-size: 13px;">Internal Compliance Committee</li></a> -->
						...
						<h2 class="title_contanier" >Cultural Activity</h2>

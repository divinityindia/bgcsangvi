				...
				success:function(data){
					...
					for (var key in data.hm2) {
						($('#DBT_STAR')).append('<li type="disc">'
							+'<a href="'+s3pat+'IQAC/DBT_STAR/'+key+'/'+data.hm2[key][0]+'" target="_blank">'+data.hm2[key][0]+'</a>'
							+'</li>');
			        }
				},
				error:function(data){}
								...
								<div class="tg-widget tg-widgetaboutusnav">
									...
									<hr>
										<ul class="listul" >
											...
											<a href="Iqacnotices.jsp"><li class="des active" style="font-size: 13px;">IQAC Notices</li></a>

...
<body>
  ...
  <div class="container" style="padding:10px;">
	...
	<div class="panel panel-primary">
      <div class="panel-heading"><b>Event Details</b></div>
      <div class="panel-body">
      	<table class="table">
      		...
      		<tr>
      			<td>Document</td>
      			<td><a href="${s3pat}events/${param.id}/${info[10]}" target="_blank">${info[10]}</a></td>
      		</tr>
      		<tr>
      			<td>URL</td>
      			<td>${info[11]}</td>
      		...
      		<tr>
      			<td>Start Date</td>
      			<td>${info[13]} &nbsp;&nbsp;&nbsp;&nbsp; ${info[14]}</td>
      		</tr>
      		<tr>
      			<td>End Date</td>
      			<td>${info[15]} &nbsp;&nbsp;&nbsp;&nbsp; ${info[16]}</td>
      		</tr>

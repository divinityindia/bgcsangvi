...
<!-- 											<a href="DBTStarCollege?type=Annualreports"><li class="des">Annual reports</li></a> -->
											...
											<a href="DBTStarCollege?type=Notices"><li class="des active">Notices</li></a>
						...
						<h2 class="title_contanier" >DBT Star College Notices </h2>
...
<!-- 								  <b style="font-family: sans-serif; font-size: 16px;color: #43577B;font-weight: bold;">Major equipments in various laboratories</b> -->
										...
										<h4 style="text-align: left; color: #43577B!important;font-weight: bold;">Notices </h4>
										<table id="myTable" class="Vscroll">
								  			...
								  			<tbody style="color: black;">
								  			   <c:forEach items="${dbtdtl}" var="ct" varStatus="r">
								  				<tr >
								  					<td width="8%;" style="padding: 7px;">${r.count}</td>
								  					<td style="text-align: left;padding-left: 3px;">
								  					<c:choose>
								  					 <c:when test="${ct.boption eq 'Yes'}">
								  					${ct.ntitle}<span class="quadrat1" style="font-weight: bold;">&nbsp;&nbsp;New</span>
								  					</c:when>
								  					<c:otherwise>
								  					${ct.ntitle}
								  					</c:otherwise>
								  					...
								  					<c:choose>
								  					 <c:when test="${ct.boption eq 'Yes'}">
								  					<a href="${s3pat}DBT_Star_Notices/${ct.dbsid}_${ct.document}" target="_blank" style="color: #a52a35;"><i style="font-size:22px" class="fa">&#xf1c1;</i>&nbsp;&nbsp; Attach Document<span class="quadrat1" style="font-weight: bold;">&nbsp;&nbsp;New</span></a>
								  					</c:when>
								  					<c:otherwise>
								  					<a href="${s3pat}DBT_Star_Notices/${ct.dbsid}_${ct.document}" target="_blank" style="color: #a52a35;"><i style="font-size:22px" class="fa">&#xf1c1;</i>&nbsp;&nbsp; Attach Document</a>
								  					</c:otherwise>
								  					</c:choose>

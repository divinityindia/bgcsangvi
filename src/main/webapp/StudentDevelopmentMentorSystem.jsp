								...
								<div class="tg-widget tg-widgetaboutusnav">
									...
									<hr style="border: 1px solid gray;">
										<ul class="listul" >
											...
											<a href="StudentDevelopment?type=Mentor System&pgnm=StudentDevelopmentMentorSystem"><li class="des active" style="font-size: 13px;">Mentor System</li></a>
...
<!-- 											<a href="InternalComplianceCommittees.jsp"><li class="des" style="font-size: 13px;">Internal Compliance Committee</li></a> -->
						...
						<h2 class="title_contanier" >Mentor System</h2>
						  <div class="outer-div">
						  						  
						  
						  </div>
						     <center>
						     <a href="${s3pat}PolicyProcedure/${dtl.ppid}_${dtl.document}" target="_blank" style="color: blue;font-size: 15px;">&#9755;  Click Here for Mentor System</a>
							</center>			
						</div>
						</div>
					</div>

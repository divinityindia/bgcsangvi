								...
								<div class="tg-widget tg-widgetaboutusnav">
									...
									<hr style="border: 1px solid black;">
										<ul class="listul" >
											...
											<a href="Recognizedresearchguides.jsp"><li class="des active" style="font-size: 13px;">Recognized research guides</li></a>
						...
						<div id="container1">
						  <div id="container2" ><br>
						          <table  width="100%">
										...
										<th style="color: #003135; background: #fdd991;border:1px solid #003135; padding: 12px;">Name of the guide</th>
										<th style="color: #003135; background: #fdd991;border:1px solid #003135; padding: 12px;">Subject</th>
										<th style="color: #003135; background: #fdd991;border:1px solid #003135; padding: 12px;">M.Phil-Registered</th>
										<th style="color: #003135; background: #fdd991;border:1px solid #003135; padding: 12px;">M.Phil-Awarded</th>
										<th style="color: #003135; background: #fdd991;border:1px solid #003135; padding: 12px;">Ph.D.-Registered</th>
										<th style="color: #003135; background: #fdd991;border:1px solid #003135; padding: 12px;">Ph.D.-Awarded</th>
										</tr>
										<tr height="20">
										<td style="padding: 10px;">1 </td>
										<td style="padding: 10px;">Dr. Ghorpade N.L</td>
										<td style="padding: 10px;">Commerce </td>
										<td style="padding: 10px;">02</td>
										<td style="padding: 10px;">03 </td>
										<td style="padding: 10px;">07</td>
										...
										<td style="padding: 10px;">Dr. Dangat N.R.</td>
										...
										<td style="padding: 10px;">Dr. Salve T.N.</td>
										<td style="padding: 10px;">Economics </td>
										<td style="padding: 10px;">08</td>
										<td style="padding: 10px;">00 </td>
										...
										<td style="padding: 10px;">Dr. Shitole T.A</td>
										<td style="padding: 10px;">Geography </td>
										<td style="padding: 10px;">06</td>
										<td style="padding: 10px;">00 </td>
										...
										<td style="padding: 10px;">Dr. Kshirsagar R.V.</td>
										...
										<td style="padding: 10px;">Dr.Savita Singh</td>
										...
										<td style="padding: 10px;">Dr.Khandagale A.J.</td>
										<td style="padding: 10px;">Zoology </td>
										<td style="padding: 10px;">00</td>
										<td style="padding: 10px;">00 </td>
										<td style="padding: 10px;">--</td>
										...
										<td style="padding: 10px;">Dr. Cholke P. B.</td>
										<td style="padding: 10px;">Botany</td>
										<td style="padding: 10px;">01</td>
										<td style="padding: 10px;">Nill </td>
										<td style="padding: 10px;">--</td>
										<td style="padding: 10px;">--</td>
										</tr>
										<tr height="20">
										<td style="padding: 10px;">10 </td>
										<td style="padding: 10px;">Dr. Tambade P.S.</td>

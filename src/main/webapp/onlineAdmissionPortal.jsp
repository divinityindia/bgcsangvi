			...
			<%-- <center><h1 style="padding:5px;border:0px solid brown; font-weight: bold;">BBA</h1></center> --%>
				<div class="row" style="margin-top: 2%;">
					<div id="tg-twocolumns" class="tg-twocolumns">
							...
							<aside id="tg-sidebar" class="tg-sidebar">
								<div class="tg-widget tg-widgetaboutusnav">
									...
									<hr style="border: 1px solid black;">
										<ul class="listul" >
										<a href="AdmissionProcedure.jsp" ><li class="des">Admission Procedure </li></a>
											...
											<a href="onlineAdmissionPortal.jsp"><li class="des active">online Admission Portal</li></a>
						...
						<h2 class="title_contanier" >online Admission Portal</h2>
						 <hr style="border: 1px solid;">
						<div id="container1">
						  <div id="container2" >
						     		<p><i><strong> Online Admission Link: </strong></i><a href="http://www.pdea-admission.org/" target="_blank">Online Admission</a></p>
									<br>

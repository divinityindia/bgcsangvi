...
<style>
				...
				<!-- <div class="row">
					...
					<br>
						<ol class="tg-breadcrumb">
							<li style="display: inline-block;" ><a href="Academics.jsp" >Home</a></li>->
							
							<li class="tg-active" style="display: inline-block;">Eligibility Details </li>
						</ol>
					</div>
				</div> -->
  ...
  <div class="container">
  <h3 align="center">Eligibility Details </h3>
         <table id="customers" >
							             ...
							             <tr> 
							                 ...
							                 <td  style="text-align: left;"><a href="${s3pat}eligibility/${cat.key}/${cat.value[3]}" target="_blank" >${cat.value[3]}</a></td>
							             </tr>
							            </c:forEach>
							       </table>

				...
				success:function(data){
					...
					for (var key in data.hm) {
						($('#myTableAcademicCalender tbody')).append('<tr >'
							+'<td>'+ ++sno+'</td>'
							+'<td style="text-align:left;">'+data.hm[key][0]+'</td>'
							+'<td style="text-align:left;"><a href="'+s3pat+'academic_calender/'+key+'/'+data.hm[key][1]+'" target="_blank">'+data.hm[key][1]+'</a></td>'
							+'</tr>');
			        }
				},
				error:function(data){}
			...
			<%-- <center><h1 style="padding:5px;border:0px solid brown; font-weight: bold;">BBA</h1></center> --%>
				<div class="row" style="margin-top: 2%;">
					<div id="tg-twocolumns" class="tg-twocolumns">
						<div class="col-xs-12 col-sm-4 col-md-3 col-lg-3">
							<aside id="tg-sidebar" class="tg-sidebar">
								<div class="tg-widget tg-widgetaboutusnav">
									...
									<hr>
										<ul class="listul" >
											<a href="ProgramOutcomes.jsp" ><li class="active des">Course Outcome / Program Outcome</li></a>
						...
						<h2 class="title_contanier" >Course Outcome / Program Outcome</h2>
						 <hr>
						<div id="container1">
						  <div id="container2" >

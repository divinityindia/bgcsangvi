								...
								<div class="tg-widget tg-widgetaboutusnav">
									...
									<hr style="border: 1px solid black;">
										<ul class="listul" >
											...
											<a href="AdmissionReservationPolicy"><li class="des active">Reservation Policy</li></a>
						  ...
						  <div id="container2" >
										...
										<table class="info" style="width: 100%;">
											...
											<c:forEach var="cat" items="${dtl}" varStatus="row">
								  				<tr>
								  				     <td>${row.count}</td>
								  				     <td><a href="${s3pat}AddAdmission/${cat.adid}_${cat.document}" target="_blank">${cat.document}</a></td>
								  				</tr>
								  			</c:forEach>

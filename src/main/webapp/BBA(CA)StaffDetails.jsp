			...
			<%-- <center><h1 style="padding:5px;border:0px solid brown; font-weight: bold;">Computer Science</h1></center> --%>
				<div class="row" style="margin-top: 2%;">
					<div id="tg-twocolumns" class="tg-twocolumns">
								...
								<div class="tg-widget tg-widgetaboutusnav">
									...
									<hr style="border: 1px solid black;">
										<ul class="listul" >
											...
											<a href="GetDepWiseEmp?did=16&pgnm=BBA(CA)StaffDetails"><li  class="active des">Staff Details</li></a>
											<a href="GetDepWiseEvent?did=16&pgnm=BBA(CA)EventandPhotos"><li class="des">Events & Photos</li></a>
						...
						<h2 class="title_contanier" >B.B.A.(CA) Department Staff Details</h2>

				...
				if(data!=null){
					...
					$.each(data.al, function (i, item) {
						$("#st").append('<tr>'
								+'<td>'+sr+'</td>'
								/* +'<td>'+item.subject+'</td>' */
								+'<td><a href="ShowAllCS?ty='+item.semester+'" target="_blank"> '+item.semester+'</a></td>'
							/* 	+'<td>'+item.details+'</td>'
					...
					<div id="tg-twocolumns" class="tg-twocolumns">
								...
								<div class="tg-widget tg-widgetaboutusnav">
									...
									<hr style="border: 1px solid black;">
										<ul class="listul" >
											...
											<a href="Results.jsp"><li class="des">Results</li></a>
											<a href="EligibilityNumbers.jsp"><li class="des">Eligibility Numbers</li></a>
											<a href="CyberSecurity.jsp"><li class="des active">Cyber Security</li></a>
										</ul>
									</div>
								</div>
							</aside>
						...
						<div id="container1">
						  <div id="container2" >
						    <ul>
									    <li>
									     <a href="${s3pat}CyberSecurity/Syllabus.pdf" target="_blank"> &#9755;  Syllabus</a>
									    </li>
									   <!--   <li>
                                      ...
                                      <table id="countrytable" class="Vscroll">
									  			<thead>
									  				<tr>
									  					...
									  					<th style="color: #003135; background: #fdd991;border:1px solid #003135; ">Semester</th>
									  				</tr>

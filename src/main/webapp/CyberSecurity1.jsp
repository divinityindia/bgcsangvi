							...
							<aside id="tg-sidebar" class="tg-sidebar">
								<div class="tg-widget tg-widgetaboutusnav">
									...
									<hr style="border: 1px solid black;">
										<ul class="listul" >
											<a href="Syllabus1.jsp"><li class="des">Syllabus</li></a>
											<a href="OldQuestionPapers1.jsp"><li class="des">Old Question Papers</li></a>
											<a href="Results1.jsp"><li class="des">Results</li></a>
											<a href="EligibilityNumbers1.jsp"><li class="des">Eligibility Numbers</li></a>
											<a href="CyberSecurity1.jsp"><li class="des active">Cyber Security</li></a>
										</ul>
									</div>
								</div>
							</aside>

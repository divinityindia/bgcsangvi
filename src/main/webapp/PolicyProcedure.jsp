...
<center><h1 style="color:blue;">Policy And Procedure</h1></center>
				...
				<div class="row">
					...
					<div class="col-md-12">
						...
						<div class="VerticalTab  VerticalTab_6 tabs_ver_6">
							...
							<li class="tabs-1"><i class="fc_icons fa fa-tasks"></i> <span class="tabs-text">Curriculum Delivery</span></li>
							<li class="tabs-2"><i class="fc_icons fa fa-tasks"></i> <span class="tabs-text">Academic</span></li>
							<li class="tabs-3"><i class="fc_icons fa fa-tasks"></i> <span class="tabs-text">Mentor </span></li>
							<li class="tabs-4"><i class="fc_icons fa fa-tasks"></i> <span class="tabs-text">Physical And Academic Facility</span></li>
							</ul>

							<div class="resp-tabs-container hor_1 ">
							<div class="fc-tab-1">
									<h2 class="title_contanier">Curriculum Delivery</h2>

										
										<p><i><strong>Curriculum Delivery:</strong></i></p>	
									<div style=" width: 100%; height: 400px; overflow: scroll;">
										<table  style="width: 100%; ">
											...
											<c:forEach var="cat" items="${dtl}" varStatus="row">
								  				<tr>
								  				     <td>${row.count}</td>
								  				     <td><a href="https://s3.us-east-2.amazonaws.com/test-rmc-bucket/PolicyProcedure/${cat.ppid}_${cat.document}" target="_blank">${cat.document}</a></td>
								  				</tr>
								  			</c:forEach>
								...
								<div class="fc-tab-2">
									<h2 class="title_contanier">Academic</h2>

										
										<p><i><strong>Academic:</strong></i></p>	
									<div style=" width: 100%; height: 400px; overflow: scroll;">
								...
								<div class="fc-tab-3">
									<h2 class="title_contanier">Mentor</h2>

										
										<p><i><strong>Mentor:</strong></i></p>	
									<div style=" width: 100%; height: 400px; overflow: scroll;">
										<table class="info" style="width: 100%;">
											<tr style="background-color: #187F9D; ">
												<th>Sr. No.</th>
											...
											<c:forEach var="cat" items="${dtl2}" varStatus="row">
								  				<tr>
								  				     <td>${row.count}</td>
								  				     <td><a href="https://s3.us-east-2.amazonaws.com/test-rmc-bucket/PolicyProcedure/${cat.ppid}_${cat.document}" target="_blank">${cat.document}</a></td>
								  				</tr>
								...
								<div class="fc-tab-4">
									<h2 class="title_contanier">Physical And Academic Facility</h2>

										
										<p><i><strong>Physical And Academic Facility:</strong></i></p>	
									<div style=" width: 100%; height: 400px; overflow: scroll;">	
										<table class="info" style="width: 100%;">
											<tr style="background-color: #187F9D; ">
												<th>Sr. No.</th>
											...
											<c:forEach var="cat" items="${dtl3}" varStatus="row">
								  				<tr>
								  				     <td>${row.count}</td>
								  				     <td><a href="https://s3.us-east-2.amazonaws.com/test-rmc-bucket/PolicyProcedure/${cat.ppid}_${cat.document}" target="_blank">${cat.document}</a></td>
								  				</tr>

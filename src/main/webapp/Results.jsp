			...
			success:function(data){
				...
				for (var key in data.hm) {
					($('#myTable tbody')).append('<tr >'
							...
							+'<td>'+data.hm[key][1]+'</td>'
							+'<td>'+data.hm[key][2]+'</td>'
							+'<td><a href="https://s3.us-east-2.amazonaws.com/test-rmc-bucket/results/'+key+'/'+data.hm[key][3]+'" target="_blank">'+data.hm[key][3]+'</a></td>'
...
<body>
  ...
  <div class="container">
		...
		<h3 style="color: #43577B; font-weight: bold;">Results</h3>

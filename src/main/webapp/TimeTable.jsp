...
<!-- 											<a href="GetInfra" ><li class="des">Physical Facilities in college</li></a> -->
											<a href="TimeTable"><li class="des ">Time Table</li></a>
						...
						<h2 class="title_contanier" >Time Table</h2>
										...
										<table id="myTable" class="Vscroll">
							  			...
							  			<c:forEach var="cat" items="${ttdtls}" varStatus="row">
							  				<tr>
							  				     ...
							  				     <td width="20%" style="text-align: left;"><a href="${s3pat}AddTimeTable/${cat.ttid}_${cat.document}" target="_blank">${cat.document}</a></td>
							  				</tr>
							  			</c:forEach>

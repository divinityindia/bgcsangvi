	...
	<div id="tg-wrapper" class="tg-wrapper">
		...
		*************************************-->
		<main id="tg-main" class="tg-main tg-haslayout">
			...
			<center><h1 style="padding:5px;border:0px solid brown; font-weight: bold;color:#09919c!important">College Activity</h1></center>
			<hr style="border: 1px solid;">
				<div class="row" style="margin-top: 2%;">
					<div id="tg-twocolumns" class="tg-twocolumns">
					  <c:forEach items="${cmtdtls}" var="ct">
						<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
						    <a href="CollegeActivityEventes?cmid=${ct.cmid}&cmnm=${ct.comtname}" class="button">${ct.comtname}</a>
						</div>
					 </c:forEach>
					</div>
				</div>

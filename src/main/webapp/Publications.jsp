				...
				<div class="row" style="margin-top: 2%;">
					<div id="tg-twocolumns" class="tg-twocolumns">
								...
								<div class="tg-widget tg-widgetaboutusnav">
									...
									<hr style="border: 1px solid black;">
										<ul class="listul" >
											...
											<a href="Publications.jsp"><li class="des active" style="font-size: 13px;">Publications by the faculty </li></a>
                        ...
                        <table  width="100%">
									...
									<th style="color: #003135; background: #fdd991;border:1px solid #003135; padding: 12px;">National</th>
									<th style="color: #003135; background: #fdd991;border:1px solid #003135; padding: 12px;">International</th>
									</tr>
									<tr height="20">
									...
									<td style="padding: 10px;">Computer Science</td>
									<td style="padding: 10px;">01</td>
									<td style="padding: 10px;">01</td>
									</tr>
									<tr height="20">
									...
									<tr height="20">
									<td style="padding: 10px;">11</td>
									<td style="padding: 10px;">Politics</td>

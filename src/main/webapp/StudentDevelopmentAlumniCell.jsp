								...
								<div class="tg-widget tg-widgetaboutusnav">
									...
									<hr>
										<ul class="listul" >
											...
											<a href="StudentDevelopment?type=Alumni Cell&pgnm=StudentDevelopmentAlumniCell"><li class="des active" style="font-size: 13px;">Alumni Cell</li></a>
...
<!-- 											<a href="InternalComplianceCommittees.jsp"><li class="des" style="font-size: 13px;">Internal Compliance Committee</li></a> -->
						...
						<h2 class="title_contanier" >Alumni Cell</h2>
						  <div class="outer-div" style="width: 100%;padding: 0px;">
						      <p style="color: #842a0f;font-family: sans-serif;font-size: 16px;font-weight: bold;">
								<b>Aim</b> 
							</p>
							<p style="color:black ;font-family: sans-serif;font-size: 15px;margin-left: 20px;">
							To involve alumni in overall development of the College and the Society 
							</p>
							<p style="color: #842a0f;font-family: sans-serif;font-size: 16px;font-weight: bold;">
								<b>Objectives</b> 
							</p>
							<ul style="color:black ;font-family: sans-serif;font-size: 15px;margin-left: 20px;list-style-type: square;">
							    <li>To bring together all the past students and the College to share their experiences with each other.</li>
							    <li>Toutilise the rich experiences of old students of the college for the benefit
							    and progress of the present students.</li>
							    <li> To provide guidance to the present students in their endeavour for better employment and higher studies.</li>
							    <li> To promote the campus placements through the old students working in reputed industries in India and abroad.</li>
							    <li> To get the valuable advices of the Alumni in the overall development of the college.</li>
							...
							<ul style="color:black ;font-family: sans-serif;font-size: 15px;margin-left: 20px;list-style-type: square;">
							   <li>
							   Maintain an update  and detail data base of the alumni</li>
							   <li> Arrange sessions for sharing of their experiences with the current students</li>
							   <li> Take feedback from alumni on curriculum and infrastructure.</li>

							</ul>
							<p style="color: #842a0f;font-family: sans-serif;font-size: 16px;font-weight: bold;">
								<b>Committee Co-ordinator</b> 
							</p>
							<ul style="color:black ;font-family: sans-serif;font-size: 15px;margin-left: 20px;list-style-type: square;">
							     <li>Prof. V. S. Ghare</li>
							</ul>
							<p style="color: #842a0f;font-family: sans-serif;font-size: 16px;font-weight: bold;">
							...
							<ul style="color:black ;font-family: sans-serif;font-size: 15px;margin-left: 20px;list-style-type: square;">
							     <li>Dr. V.M. Bansod</li>
							     <li>DR.J.Y. WADSHINGKAR</li>
							     <li>Dr. V.D. Pathare Lt.</li>
							     <li>LT.V.A.NAIKWADI</li>
							     <li>Prof. S.N. Mane</li>
							     <li>Dr. V.H. Ghadage</li>
							     <li>Dr. S.S. Chowhan</li>
							     <li>Mr. D.S. Jambhulkar</li>
							     <li>Mrs. S.V. Sonar</li>
							     <li>Mrs. V.S. Shinde</li>
							      <li>Mr. S.P. Bhosale</li>
							     <li>Prasad Jadhav (Alumni)</li>

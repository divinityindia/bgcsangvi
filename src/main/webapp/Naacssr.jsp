			...
			$.ajax({
				...
				success:function(data){
					...
					for (var key in data.hm) {
						...
						($('#UGC_CPE_Div')).append('<tr> <td style="padding:5px;color:black!important;text-align:left;padding-left:50px;"> '
								...
								<div class="tg-widget tg-widgetaboutusnav">
									...
									<hr>
										<ul class="listul" >
											...
											<a href="Naacssr.jsp"><li class="des active" style="font-size: 13px;">NAAC SSR Document</li></a>
						...
						<div id="container1">
						  <div id="container2" >
						    <ol id="UGC_CPE">
										...
										<table id="UGC_CPE_Div" style="width:90%; border:1px solid black;  margin-left: 5%; he">
										    <tr>
	                                         
	                                               <th  style="color: #003135; background: #fdd991;border:1px solid #003135; ">NAAC SSR Document</th>
										</tr>
										</table>
									 </div>
						  </div>

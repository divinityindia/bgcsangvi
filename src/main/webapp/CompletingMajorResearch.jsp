								...
								<div class="tg-widget tg-widgetaboutusnav">
									...
									<hr style="border: 1px solid black;">
										<ul class="listul" >
											...
											<a href="CompletingMajorResearch.jsp"><li class="des active" style="font-size: 13px;">Completing Major Research Project</li></a>
						...
						<div id="container1">
						  <div id="container2" ><br>
                             <table  width="100%">
										...
										<td style="padding: 10px;">1/2/2010 to 31/1/2012</td>
										<td style="padding: 10px;">Comparative study of comprehensive Rural Development 
										    in Pune & Ahmednagar District of Maharashtra</td>
										<td style="padding: 10px;">UGC</td>
										<td style="padding: 10px;">4, 25,200</td>
										<td style="padding: 10px;">269200</td>
										<td style="padding: 10px;">269200</td>
										</tr>
										</tbody>
										</table>

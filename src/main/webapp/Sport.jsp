					...
					<div id="tg-twocolumns" class="tg-twocolumns">
								...
								<div class="tg-widget tg-widgetaboutusnav">
									...
									<hr style="border: 1px solid black;">
										<ul class="listul" >
											...
											<a href="Sport.jsp"><li class="des active">Sports</li></a>
						...
						<h2 class="title_contanier" >Sports</h2>
						 <hr style="border: 1px solid;">
								<div id="container1">
								  <div id="container2" >
								  <p style="font-family: sans-serif; font-size: 14px;color: black;"><strong style="font-family: sans-serif; font-size: 16px;color: #43577B;font-weight: bold;">Indoor  facilities<br /> </strong>College  has a physical education centre, commonly referred as Gymkhana, which is  renovated and modernized in the year 2008-09. Modern multigym 7 station  facility is available for the students. In the gymkhana, one table of “table  tennis” and four carom boards are placed with sufficient light arrangements. We  have enough number of Chess- boards. Gymkhana is open for students between  08:00 a.m. to 06:00 p.m.</p>
									<p style="font-family: sans-serif; font-size: 14px;color: black;"><strong style="font-family: sans-serif; font-size: 16px;color: #43577B;font-weight: bold;">Outdoor  Sports Facilities on the college campus</strong><br /> Volleyball Ground,<br /> Kho-Kho ground,<br /> Kabaddi Ground,<br /> Basketball Court,</p>
									<p style="font-family: sans-serif; font-size: 14px;color: black;"><strong style="font-family: sans-serif; font-size: 16px;color: #43577B;font-weight: bold;">Outdoor  Sports Facilities on the Sanjay Kale playground of the PCMC</strong><br /> Football Ground,<br /> Cricket pitch,<br /> Handball Ground,<br /> Badminton court</p>

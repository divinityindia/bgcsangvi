						...
						<div class="col-xs-12 col-sm-4 col-md-3 col-lg-3">
							<aside id="tg-sidebar" class="tg-sidebar">
								<div class="tg-widget tg-widgetaboutusnav">
									...
									<hr>
										<ul class="listul" >
											<a href="AboutIQAC.jsp" ><li class=" des" style="font-size: 13px;">About IQAC</li></a>
											...
											<a href="Iqmatr"><li class="des active" style="font-size: 13px;">IQAC Minutes & Action Taken Report</li></a>
						...
						<div id="container1">
						  <div id="container2" >
										...
										<table class="table">
											...
											<tbody>
											 <c:forEach items="${cat}" var="dt" varStatus="row">
												<tr>
												     <td>${row.count}</td>
												     <td style="text-align: left;">${dt.title}</td>
												     <td>${dt.year}</td>
												     <td style="text-align: left;"><a href="${s3pat}IQMATRFiles/${dt.iqid}_${dt.document}" target="_blank">${dt.document}</a></td>
												</tr>
											</c:forEach>
											</tbody>
										</table>

								...
								<div class="tg-widget tg-widgetaboutusnav">
									...
									<hr>
										<ul class="listul" >
											...
											<a href="StudentDevelopment?type=Placement&pgnm=StudentDevelopmentPlacement"><li class="des active" style="font-size: 13px;">Placement</li></a>
...
<!-- 											<a href="InternalComplianceCommittees.jsp"><li class="des" style="font-size: 13px;">Internal Compliance Committee</li></a> -->
						...
						<h2 class="title_contanier" >Placement Cell</h2>
						  <div class="outer-div" style="width: 100%;height: 700px;overflow: scroll;padding: 0px;">
						   <div class="row" style="margin-top: 0%; height: auto;">
						    <div class="col-md-6" style="padding: 40px;">
						      <p style="color: #842a0f;font-family: sans-serif;font-size: 16px;font-weight: bold;">
								<b>Placement Coordinator</b>
							 </p>
							 <p style="color: black ;font-family: sans-serif;font-size: 15px;margin-left: 20px;">
							     <b style="color: #177e88;">Dr. Narshing Giri</b><br>
                                 <b>Email-ID:-</b> giri.narshing@gmail.com<br>
                                 <b>Contact No.:-</b> 9689901127
							</p>
							
						    </div>
						    <div class="col-md-6" align="right">
						       <img alt="" src="pcell_img/pc1.png" style="height: 200px;">
						    </div>
						    </div>
							...
							<ul style="color:black ;font-family: sans-serif;font-size: 15px;margin-left: 20px;list-style-type: square;">
							    ...
							    <li>Identify suitable potential employers and help them achieve their hiring goals.
							    </li>
							    ...
							    <li>Organizes training sessions on soft skill development .</li>
							    <li>To arrange various Seminars/ Expert lectures/ Career awareness program etc. to prepare the students for facing the interviews.
							    </li>
							</ul>
							 <p style="color: #842a0f;font-family: sans-serif;font-size: 16px;font-weight: bold;">
								<b>Highlights </b> 

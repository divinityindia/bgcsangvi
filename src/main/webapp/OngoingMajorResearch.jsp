								...
								<div class="tg-widget tg-widgetaboutusnav">
									...
									<hr style="border: 1px solid black;">
										<ul class="listul" >
											...
											<a href="OngoingMajorResearch.jsp"><li class="des active" style="font-size: 13px;">Ongoing Major Research Project </li></a>
						...
						<div id="container1">
						  <div id="container2" ><br>
                              <table  width="100%">
										...
										<th style="color: #003135; background: #fdd991;border:1px solid #003135; padding: 12px;">Principal investigator</th>
										<th style="color: #003135; background: #fdd991;border:1px solid #003135; padding: 12px;">Duration Year From To</th>
										<th style="color: #003135; background: #fdd991;border:1px solid #003135; padding: 12px;">Title of the project</th>
										<th style="color: #003135; background: #fdd991;border:1px solid #003135; padding: 12px;">Name of the funding agency</th>
										<th style="color: #003135; background: #fdd991;border:1px solid #003135; padding: 12px;">Total grant Sanctioned</th>
										<th style="color: #003135; background: #fdd991;border:1px solid #003135; padding: 12px;">Total grant Received</th>
										<th style="color: #003135; background: #fdd991;border:1px solid #003135; padding: 12px;">Total grant received till date</th>
										</tr>
										<tr height="20">
										<td style="padding: 10px;">1</td>
										<td style="padding: 10px;">Dr.N.L.Ghorpade</td>
										<td style="padding: 10px;">1/3/2011 to 28/2/13</td>
										<td style="padding: 10px;">A study of effect of Meditation on Stress for teenagers</td>
										<td style="padding: 10px;">ICSSR</td>
										<td style="padding: 10px;">3,76,400</td>
										<td style="padding: 10px;">352000</td>
										<td style="padding: 10px;">352000</td>
										</tr>
										<tr height="20">
										<td style="padding: 10px;">2</td>
										<td style="padding: 10px;">Dr.Shriram V. D.</td>
										<td style="padding: 10px;">1/2/2011 to 31/1/2014</td>
										<td style="padding: 10px;">Phytochemical investigations for 
										...
										<td style="padding: 10px;">UGC</td>
										<td style="padding: 10px;">9 51,000</td>
										<td style="padding: 10px;">501800</td>
										<td style="padding: 10px;">501800</td>
										</tr>
										<tr height="20">
										<td style="padding: 10px;">3</td>
										<td style="padding: 10px;">Dr. Cholke Privan</td>
										<td style="padding: 10px;">15/9/12 to 15/9/14</td>
										<td style="padding: 10px;">Assessment of aerobiocomponants at garbage depot 
										of moshi & sick building of pimpari chinchwad</td>
										<td style="padding: 10px;">UGC</td>
										<td style="padding: 10px;">836300</td>
										<td style="padding: 10px;">836300</td>
										<td style="padding: 10px;">479800</td>
										</tr>
										<tr height="20">
										<td colspan="7" style="padding: 10px;"></td>
										<td style="padding: 10px;">1602800</td>
										</tr>
										</tbody>
										</table>

			...
			<%-- <center><h1 style="padding:5px;border:0px solid brown; font-weight: bold;">Botany</h1></center> --%>
				<div class="row" style="margin-top: 2%;">
					<div id="tg-twocolumns" class="tg-twocolumns">
								...
								<div class="tg-widget tg-widgetaboutusnav">
									...
									<hr style="border: 1px solid black;">
										<ul class="listul" >
											...
											<a href="GetDepWiseCourseStruct?did=26&pgnm=BotanyCourseStructure"><li class="active des">Course Structure</li></a>
						...
						<h2 class="title_contanier" >Botany Department Course Structure</h2>

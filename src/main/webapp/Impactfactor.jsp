					...
					<div id="tg-twocolumns" class="tg-twocolumns">
								...
								<div class="tg-widget tg-widgetaboutusnav">
									...
									<hr style="border: 1px solid black;">
										<ul class="listul" >
											...
											<a href="Impactfactor.jsp"><li class="des active" style="font-size: 13px;">Impact factor</li></a>
						...
						<div id="container1">
						  ...
						  <table  width="100%">
									...
									<tbody>
									<tr>
									<td style="color: #003135; background: #fdd991;border:1px solid #003135; padding: 12px;"> Sr. no</td>
									<td style="color: #003135; background: #fdd991;border:1px solid #003135; padding: 12px;">Department</td>
									<td style="color: #003135; background: #fdd991;border:1px solid #003135; padding: 12px;">No. of books</td>
									</tr>
									<tr height="20">
									<td style="padding: 10px;">1</td>
									<td style="padding: 10px;">Botany</td>
									<td style="padding: 10px;">15.3 & 0.23</td>
									</tr>
									<tr height="20">
									<td style="padding: 10px;">2</td>
									<td style="padding: 10px;">Chemistry</td>
									<td style="padding: 10px;">2.01</td>
									</tr>
									<tr height="20">
									...
									<td style="padding: 10px;">2.149</td>
									</tr>

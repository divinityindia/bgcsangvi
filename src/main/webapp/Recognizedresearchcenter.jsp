			...
			<%-- <center><h1 style="padding:5px;border:0px solid brown; font-weight: bold;">BBA</h1></center> --%>
				<div class="row" style="margin-top: 2%;">
					<div id="tg-twocolumns" class="tg-twocolumns">
								...
								<div class="tg-widget tg-widgetaboutusnav">
									...
									<hr style="border: 1px solid black;">
										<ul class="listul" >
											...
											<a href="Recognizedresearchcenter.jsp"><li class="des active" style="font-size: 13px;">Recognized research center</li></a>
						...
						<h2 class="title_contanier" >Recognized as research center of the University of Pune</h2>
						 <hr style="border: 1px solid;">
						<div id="container1">
						  <div id="container2" ><br><br>
						          <ul style="margin-left:10%; list-style-type: square; font-size: 15px;">
						              <li style="font-size: 15px;font-weight: bold;">Recognized as research centre of the University of Pune for the M.Phil and Ph.D. Programmes.<br>
						                   <ul style="margin-left:5%;list-style-type: square;font-weight: normal;">
						                       <li>Research Centre in Economics </li>
						                       <li>Research Centre in Geography </li>
						                       <li>Research Centre in Zoology</li>
						                       <li>Research Centre in Commerce  </li>
						                       <li>Research Centre in Chemistry </li>
						                       <li>Research Centre in Botany</li>
						          ...
						          <br>
						           <ul style="margin-left:10%; list-style-type: square; font-size: 15px;">
						              <li style="font-size: 15px;font-weight: bold;">11 patents obtained
						              </li><br>
						              <li style="font-size: 15px;font-weight: bold;">Total number of students registered for Ph.D. 52
						              </li><br>
						              <li style="font-size: 15px;font-weight: bold;">Total number of Ph.D. Awarded 06
						              </li><br>
						              <li style="font-size: 15px;font-weight: bold;">Total number of Students registered for M.Phil 196
						              </li><br>
						              <li style="font-size: 15px;font-weight: bold;">Total number of M. Phil awarded. 98
						              </li>
						          </ul> 

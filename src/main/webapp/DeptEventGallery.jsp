...
<div class="tg-innerbanner">
				...
				<div class="row">
					...
					<br>
						<ol class="tg-breadcrumb">
							...
							<li style="display: inline-block;">Main Gallery</li>
  ...
  <div class="container" style="padding:10px;">
		...
		<div style="text-align: center">
			<h4 style="color:brown">${bean.caption}</h4>
		</div>
		...
		<c:forEach var="rec" items="${hm}">
			<div class="imgDiv">
				<a class='highslide' href='${s3pat}DeptEventpics/${rec.value[0]}_${rec.value[2]}'' onclick="return hs.expand(this)">
				<img src='${s3pat}DeptEventpics/${rec.value[0]}_${rec.value[2]}' alt='Mountain valley'/></a>
			</div>
		</c:forEach>
		</div>
		</div>

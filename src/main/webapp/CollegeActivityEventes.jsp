	...
	<div id="tg-wrapper" class="tg-wrapper">
		...
		*************************************-->
		<main id="tg-main" class="tg-main tg-haslayout">
			...
			<center><h1 style="padding:5px;border:0px solid brown; font-weight: bold;color:#09919c!important;font-size: 16px;">${cnmn} Events</h1></center>
  		...
  		<table id="myTable" class="Vscroll">
  			<thead>
  				<tr>
  					...
  					<th style="color: #fff; background: #002e3b;border:1px solid #003135; ">Report / Photo</th>
  				</tr>
  			</thead>
  			<tbody>
  			<c:forEach var="cat" items="${evdtls}" varStatus="row">
  				<tr>
  				     <td  width="10%" >${row.count}</td>
  				     <td style="text-align: left;"><a href="CollegeActivityEventPhotoes?evid=${cat.evid}&evnm=${cat.evntname}" target="_blank">${cat.evntname}</a></td>
  				     <td>
  				     <img src="${s3pat}AddCommitteeEventPhoto/${cat.pid}_${cat.pdocument}" style="width: 80px;height: 60px;" /><br>
  				     <a href="${s3pat}AddCommitteeEventReport/${cat.rpid}_${cat.rdocument}" target="_blank">${cat.rdocument}</a>
  				     </td>
  				</tr>
  			</c:forEach>

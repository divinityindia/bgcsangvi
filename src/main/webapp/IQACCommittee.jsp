								...
								<div class="tg-widget tg-widgetaboutusnav">
									...
									<hr >
										<ul class="listul" >
											...
											<a href="IQACCommittee" ><li class="des active" style="font-size: 13px;">IQAC Committee</li></a>
						    ...
						    <table class="table" id="Aqar">
											...
											<c:forEach var="cat" items="${dtl}" varStatus="row">
							  				<tr>
							  				     <td>${row.count}</td>
							  				     <td>${cat.title}</td>
							  				     <td><a href="${s3pat}IQACCommittee/${cat.acid}_${cat.document}" target="_blank">${cat.document}</a></td>
							  				</tr>
							  			</c:forEach>
											</tr>

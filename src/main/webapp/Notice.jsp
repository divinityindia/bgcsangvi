...
<body>
  ...
  <div class="container" style="padding:10px;">
	...
	<div class="panel panel-primary">
      <div class="panel-heading"><b>Notice Details</b></div>
      <div class="panel-body">
      	<table class="table">
      		<tr>
      			<td width="15%">Notice Title</td>
      			<td>${info[2]}</td>
      		</tr>
      		<tr>
      			<td>Details</td>
      		...
      		<tr>
      			<td>Document</td>
      			<td><a href="${s3pat}notice/${param.id}/${info[4]}" target="_blank">${info[4]}</a></td>
      		</tr>
      		<tr>
      			<td>URL</td>
      			<td>${info[7]}</td>

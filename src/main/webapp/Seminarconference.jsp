								...
								<div class="tg-widget tg-widgetaboutusnav">
									...
									<hr style="border: 1px solid black;">
										<ul class="listul" >
											...
											<a href="Seminarconference.jsp"><li class="des active" style="font-size: 13px;">Seminar/conference</li></a>
						...
						<div id="container1">
						  <div id="container2" ><br>
                              <table  width="100%">
										...
										<th style="color: #003135; background: #fdd991;border:1px solid #003135; padding: 12px;">Nature of the events</th>
										<th style="color: #003135; background: #fdd991;border:1px solid #003135; padding: 12px;">Year</th>
										<th style="color: #003135; background: #fdd991;border:1px solid #003135; padding: 12px;">Title</th>
										</tr>
										<tr height="20">
										<td style="padding: 10px;">1 </td>
										<td style="padding: 10px;">International Level Seminar</td>
										<td style="padding: 10px;">2009-10</td>
										<td style="padding: 10px;">Entrepreneurship for Younger Generation</td>
										</tr>
										<tr height="20">
										<td style="padding: 10px;">2 </td>
										<td style="padding: 10px;">National Level Seminar</td>
										<td style="padding: 10px;">2009-10</td>
										<td style="padding: 10px;">Disaster Managements</td>
										</tr>
										<tr height="20">
										<td style="padding: 10px;">3</td>
										<td style="padding: 10px;">State Level Seminar</td>
										<td style="padding: 10px;">2009-10</td>
										<td style="padding: 10px;">Women empowerment</td>
										</tr>
										<tr height="20">
										<td style="padding: 10px;">4</td>
										<td style="padding: 10px;">National Level Seminar</td>
										<td style="padding: 10px;">2010-11</td>
										<td style="padding: 10px;">Recent Trends in Network and Mobile Security</td>
										</tr>
										<tr height="20">
										<td style="padding: 10px;">5</td>
										<td style="padding: 10px;">State Level Seminar</td>
										<td style="padding: 10px;">2010-11</td>
										<td style="padding: 10px;">Advance technique in laboratory work</td>
										</tr>
										<tr height="20">
										<td style="padding: 10px;">6</td>
										<td style="padding: 10px;">University level Seminar</td>
										<td style="padding: 10px;">2010-11</td>
										<td style="padding: 10px;">1 Data Warehousing & Data Mining
										<br>2.Recent trends in Chemistry</td>
										</tr>
										<tr height="20">
										<td style="padding: 10px;">7</td>
										<td style="padding: 10px;">International conference</td>
										<td style="padding: 10px;">2011-12</td>
										<td style="padding: 10px;">Contemporary Issues in Management, Technology and Economics</td>
										</tr>
										<tr height="20">
										<td style="padding: 10px;">8</td>
										<td style="padding: 10px;">International conference</td>
										<td style="padding: 10px;">2011-12</td>
										<td style="padding: 10px;">Contemporary Issues in Management, Technology</td>
										</tr>
										<tr height="20">
										<td style="padding: 10px;">9</td>
										<td style="padding: 10px;">National Level Seminar</td>
										<td style="padding: 10px;">2011-12</td>
										<td style="padding: 10px;">Recent Advance in Chemical and Environmental Science</td>
										</tr>
										<tr height="20">
										<td style="padding: 10px;">10</td>
										<td style="padding: 10px;">State Level Seminar</td>
										<td style="padding: 10px;">2011-12</td>
										<td style="padding: 10px;">Cooperation, Management & Rural Development : Challenges and Opportunities</td>
										</tr>
										<tr height="20">
										<td style="padding: 10px;">11</td>
										<td style="padding: 10px;">State Level Seminar</td>
										<td style="padding: 10px;">2011-12</td>
										<td style="padding: 10px;">Yoga For Administrate Staff</td>
										</tr>
										<tr height="20">
										<td style="padding: 10px;">12</td>
										<td style="padding: 10px;">University level Seminar</td>
										<td style="padding: 10px;">2011-12</td>
										<td style="padding: 10px;">1.Female foeiticide manmade Disaster

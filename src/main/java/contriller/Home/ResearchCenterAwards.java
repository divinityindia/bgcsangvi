...
/**
 * Servlet implementation class ResearchCenterAwards
 */
@WebServlet("/ResearchCenterAwards")
public class ResearchCenterAwards extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		try 
		{
			...
			request.setAttribute("dtls", dao.getResCenAwardsByDpnm(dpnm));

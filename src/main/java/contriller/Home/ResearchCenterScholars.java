...
/**
 * Servlet implementation class ResearchCenterScholars
 */
@WebServlet("/ResearchCenterScholars")
public class ResearchCenterScholars extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		try 
		{
			...
			request.setAttribute("dtls", dao.getResCenScholarsByDpnm(dpnm));

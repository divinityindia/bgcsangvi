...
/**
 * Servlet implementation class FB_parants_college
 */
@WebServlet("/FB_parants_college")
public class FB_parants_college extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			FB_parants_college_bean bean=new FB_parants_college_bean();
			...
			bean.setR14(request.getParameter("r15"));
			...
			String result=dao.addFB_parants_college(bean);

...
/**
 * Servlet implementation class ResearchCenterCommittee
 */
@WebServlet("/ResearchCenterCommittee")
public class ResearchCenterCommittee extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		try 
		{
			...
			request.setAttribute("dtls", dao.getResCenCmtByDpnm(dpnm));

...
/**
 * Servlet implementation class FB_teacher_college
 */
@WebServlet("/FB_teacher_college")
public class FB_teacher_college extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			FB_teacher_college_bean bean=new FB_teacher_college_bean();
			...
			String result=dao.addFB_teacher_college(bean);

...
/**
 * Servlet implementation class ResearchCenterAreas
 */
@WebServlet("/ResearchCenterAreas")
public class ResearchCenterAreas extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		try 
		{
			...
			request.setAttribute("dtls", dao.getResCenAreasByDpnm(dpnm));

...
/**
 * Servlet implementation class FB_employer_employer
 */
@WebServlet("/FB_employer_employer")
public class FB_employer_employer extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			FB_employer_employer_bean bean=new FB_employer_employer_bean();
			...
			String result=dao.addFB_employer_employer(bean);

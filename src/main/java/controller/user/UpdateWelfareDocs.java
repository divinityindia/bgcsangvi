...
/**
 * Servlet implementation class UpdateWelfareDocs
 */
@WebServlet("/dir1/UpdateWelfareDocs")
public class UpdateWelfareDocs extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       try{
            ...
            int wid=dao.addWelfareDoc(WID, info, docName);

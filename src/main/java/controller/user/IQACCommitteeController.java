...
/**
 * Servlet implementation class IQACCommitteeController
 */
@WebServlet("/dir1/IQACCommitteeController")
public class IQACCommitteeController extends HttpServlet {
		...
		if(bean.isAQAR_Reports())
		{
			...
			try
			{
				...
				String filename="";
				 ...
				 IQACCommitteeBean bean2=new IQACCommitteeBean();
		       ...
		       // image=images.get(key);
		    	...
		    	if(image != null)
		    	{
				 ...
				 int id=dao.addCommittee(fields.get("title"),filename);
			    	...
			    	s3client.uploadfile(Credentials, bucketName, "IQACCommittee/"+id+"_"+filename, image, metadata);
		    	}
		    	...
		    	response.sendRedirect("IQACCommitteeController");

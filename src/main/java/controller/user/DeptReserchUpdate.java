...
/**
 * Servlet implementation class DeptReserchUpdate
 */
@WebServlet("/dir1/DeptReserchUpdate")
public class DeptReserchUpdate extends HttpServlet {
		...
		if(bean.isUGC_BSR())
		{
			try
			{
		       ...
		       // image=images.get(key);
		    	...
		    	s3client.uploadfile(Credentials, bucketName, "AddDepRes/"+fields.get("didname")+"_"+filename, image, metadata);
		    	}
		      ...
		      dao.updateDeptResUpdate(resarch, srid);
		    	
		        
		    	System.out.println("In side deptreserch post method");
		    	
		    	response.sendRedirect("DeptReserchUpdate");
		    	
		    	
		    	 /*out.println("<script type=\"text/javascript\">");
				   out.println("alert('Staff Achiv Added Sucessfully:)');");
				   out.println("location='DeptReserchUpdate';");
				   out.println("</script>");*/

...
/**
 * Servlet implementation class AddNIRFReport
 */
@WebServlet("/dir1/AddNIRFReport")
public class AddNIRFReport extends HttpServlet {
		       ...
		       // image=images.get(key);
		    	...
		    	if(image != null)
		    	{
		    	  String title=fields.get("title");
		    	   ...
		    	   NirfDao dao=new NirfDao();
		    	   int id=dao.addNirfReport(master, title, filename);
		    	metadata.setContentLength(Long.valueOf(image.available()));
		    	metadata.setContentType(documentType);
		    	s3client.uploadfile(Credentials, bucketName, "NirfReport/"+id+"_"+filename, image, metadata);
		    	}

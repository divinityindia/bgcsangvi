...
/**
 * Servlet implementation class AQARUpdate
 */
@WebServlet("/dir1/AQARUpdate")
public class AQARUpdate extends HttpServlet {
		       ...
		       // image=images.get(key);
		    	...
		    	s3client.uploadfile(Credentials, bucketName, "AQAR/"+filename, image, metadata);
		         ...
		         bean2.setDocument(filename);
		          ...
		          int id=Integer.parseInt(fields.get("aqid"));
		         AqarDao dao=new AqarDao();
		         dao.updateAQAR(bean2,id);
		    	System.out.println("In side AqarUpdate post method");

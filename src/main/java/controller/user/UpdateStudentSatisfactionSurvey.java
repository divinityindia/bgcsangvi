...
/**
 * Servlet implementation class UpdateStudentSatisfactionSurvey
 */
@WebServlet("/dir1/UpdateStudentSatisfactionSurvey")
public class UpdateStudentSatisfactionSurvey extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		if(bean.isDaily_Report()){
			try
			{
			 RequestDispatcher rd=request.getRequestDispatcher("StudentSatisfactionSurvey.jsp");
			 SSSDao dao=new SSSDao();
		       ...
		       // image=images.get(key);
		    	...
		    	if(image != null)
		    	{
				   ...
				   dao.updateFBWithFile(tlt, fname, id);
			    	...
			    	s3client.uploadfile(Credentials, bucketName, "StudentSatisfactionSurvey/"+id+"_"+filename, image, metadata);
		    	...
		    	response.sendRedirect("UpdateStudentSatisfactionSurvey");

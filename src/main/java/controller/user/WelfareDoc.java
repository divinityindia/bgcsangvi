...
/**
 * Servlet implementation class WelfareDoc
 */
@WebServlet("/dir1/WelfareDoc")
public class WelfareDoc extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(bean.isWelfare()){
			try{
				...
				request.getRequestDispatcher("WelfareDoc.jsp").forward(request, response);
			}
			catch(Exception e)
	        {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       try{
            ...
            int wid=dao.addWelfareDoc("0", info, docName);
            ...
            if(wid != 0)
            {
            	...
            	dao2.uploadFileToBucket(Credentials, bucketName, "welfare_docs/"+wid+"/"+docName, image, metadata);

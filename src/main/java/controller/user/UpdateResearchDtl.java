...
/**
 * Servlet implementation class UpdateResearchDtl
 */
@WebServlet("/dir1/UpdateResearchDtl")
public class UpdateResearchDtl extends HttpServlet {
			...
			try
			{
				con = DBConnection.createConnection();
				  ...
				  int id=Integer.parseInt(request.getParameter("id"));
					...
					RequestDispatcher rd=request.getRequestDispatcher("UpdateResearchDtl.jsp");
					request.setAttribute("dtl",dao2.getAllResearchDtl(id));
			...
			try
			{
				con = DBConnection.createConnection();
				  ...
				  String detl=request.getParameter("area");
				   ...
				   pst=con.prepareStatement("update researchdetails set deptid=?,deptname=?,details=? where rdid=?");

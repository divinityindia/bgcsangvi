...
/**
 * Servlet implementation class deptreserchpublication
 */
@WebServlet("/dir1/deptreserchpublication")
public class deptreserchpublication extends HttpServlet {
		...
		if(bean.isUGC_BSR())
		{
			try
			{
		       ...
		       // image=images.get(key);
		    	...
		    	s3client.uploadfile(Credentials, bucketName, "AddDepResPub/"+fields.get("did")+"_"+filename, image, metadata);
		    	}
               ...
               StaffResPublicationDao dao=new StaffResPublicationDao();
		    	dao.addStaffResPub(resarch);
		    	
		        
		    	System.out.println("In side deptreserch post method");
		    	response.sendRedirect("deptreserchpublication");
		    	
		    	
		    	
		    	/* out.println("<script type=\"text/javascript\">");
				   out.println("alert('Staff Achiv Added Sucessfully:)');");
				   out.println("location='deptreserchpublication';");
				   out.println("</script>");*/

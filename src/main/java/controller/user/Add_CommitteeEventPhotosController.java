...
/**
 * Servlet implementation class Add_CommitteeEventPhotosController
 */
@WebServlet("/dir1/Add_CommitteeEventPhotosController")
public class Add_CommitteeEventPhotosController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		if(bean.isGallery()){
			try
			{
			 ...
			 RequestDispatcher rd=request.getRequestDispatcher("Add_CommitteeEventPhotos.jsp");
			 request.setAttribute("cerdtl",dao.getAllCmtEvntPhotos());
			...
			try
			{
				...
				UploadObjectSingleOperation s3client = new UploadObjectSingleOperation();
				 ...
				 int cmid=Integer.parseInt(fields.get("cmid"));
				   ...
				   ActivityDao dao=new ActivityDao();
			     int id=dao.addCmtEvntPhotos(cmid,evid, imagename);
		       ...
		       // image=images.get(key);
		    	...
		    	s3client.uploadfile(Credentials, bucketName, "AddCommitteeEventPhoto/"+id+"_"+imagename, image, metadata);
		    	}
		    	
		    	
		    	session.setAttribute("erMsg", "Committee Event Photo Added Successfully....");		    	

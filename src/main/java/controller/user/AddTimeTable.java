	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		if(bean.isExam()){
			try
			{
			 ...
			 RequestDispatcher rd=request.getRequestDispatcher("AddTimeTable.jsp");
		...
		if(bean.isExam())
		{
			...
			try
			{
		       ...
		       // image=images.get(key);
		    	...
		    	s3client.uploadfile(Credentials, bucketName, "AddTimeTable/"+id+"_"+filename, image, metadata);
		    	}
		    	session.setAttribute("erMsg", "Time Table Added Successfully");

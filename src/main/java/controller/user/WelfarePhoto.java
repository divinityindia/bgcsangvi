...
/**
 * Servlet implementation class WelfarePhoto
 */
@WebServlet("/dir1/WelfarePhoto")
public class WelfarePhoto extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(bean.isWelfare()){
			try{
				...
				request.getRequestDispatcher("WelfarePhoto.jsp").forward(request, response);
			}
			catch(Exception e)
	        {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       try{
            ...
            int wid=dao.addWelfarePhotos("0", scheme, caption, docName);

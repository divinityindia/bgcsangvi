...
/**
 * Servlet implementation class fteachercollegereport
 */
@WebServlet("/dir1/fteachercollegereport")
public class fteachercollegereport extends HttpServlet {
...
protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try
		{
			...
			HashMap<Integer, FeedbackReportBean> m=dao.getTeacherCollegeReport(fid);

			if(m.get(1).getTotal()==0){
				request.getRequestDispatcher("femptyreport.jsp").forward(request, response);
			}else{

				ArrayList<FTeacherCollegeBean> list=dao.getTeacherCollegeDetailReport(fid);
				...
				//Q21
				double q21a1=(double)m.get(21).getA1()/total;
				double q21a2=(double)m.get(21).getA2()/total;
				double q21a3=(double)m.get(21).getA3()/total;
				double q21a4=(double)m.get(21).getA4()/total;
				double q21a5=(double)m.get(21).getA5()/total;

				request.setAttribute("q21a1", q21a1);
				request.setAttribute("q21a2", q21a2);
				request.setAttribute("q21a3", q21a3);
				request.setAttribute("q21a4", q21a4);
				request.setAttribute("q21a5", q21a5);
				
				//Q22
				double q22a1=(double)m.get(22).getA1()/total;
				double q22a2=(double)m.get(22).getA2()/total;
				double q22a3=(double)m.get(22).getA3()/total;
				double q22a4=(double)m.get(22).getA4()/total;
				double q22a5=(double)m.get(22).getA5()/total;

				request.setAttribute("q22a1", q22a1);
				request.setAttribute("q22a2", q22a2);
				request.setAttribute("q22a3", q22a3);
				request.setAttribute("q22a4", q22a4);
				request.setAttribute("q22a5", q22a5);
				
				//Q23
				double q23a1=(double)m.get(23).getA1()/total;
				double q23a2=(double)m.get(23).getA2()/total;
				double q23a3=(double)m.get(23).getA3()/total;
				double q23a4=(double)m.get(23).getA4()/total;
				double q23a5=(double)m.get(23).getA5()/total;

				request.setAttribute("q23a1", q23a1);
				request.setAttribute("q23a2", q23a2);
				request.setAttribute("q23a3", q23a3);
				request.setAttribute("q23a4", q23a4);
				request.setAttribute("q23a5", q23a5);
				
				//Q24
				double q24a1=(double)m.get(24).getA1()/total;
				double q24a2=(double)m.get(24).getA2()/total;
				double q24a3=(double)m.get(24).getA3()/total;
				double q24a4=(double)m.get(24).getA4()/total;
				double q24a5=(double)m.get(24).getA5()/total;

				request.setAttribute("q24a1", q24a1);
				request.setAttribute("q24a2", q24a2);
				request.setAttribute("q24a3", q24a3);
				request.setAttribute("q24a4", q24a4);
				request.setAttribute("q24a5", q24a5);
				
				//Q25
				double q25a1=(double)m.get(25).getA1()/total;
				double q25a2=(double)m.get(25).getA2()/total;
				double q25a3=(double)m.get(25).getA3()/total;
				double q25a4=(double)m.get(25).getA4()/total;
				double q25a5=(double)m.get(25).getA5()/total;

				request.setAttribute("q25a1", q25a1);
				request.setAttribute("q25a2", q25a2);
				request.setAttribute("q25a3", q25a3);
				request.setAttribute("q25a4", q25a4);
				request.setAttribute("q25a5", q25a5);

		    	request.getRequestDispatcher("fteachercollegereport.jsp").forward(request, response);
			}
		...
		{
			e.printStackTrace();
			response.sendRedirect("fteachercollegereport.jsp?success=3");
		}

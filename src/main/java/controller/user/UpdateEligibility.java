...
/**
 * Servlet implementation class UpdateEligibility
 */
@WebServlet("/dir1/UpdateEligibility")
public class UpdateEligibility extends HttpServlet {
            ...
            while (iter.hasNext())
            {
               ...
               switch(fieldName)
               {
                  ...
                  case "file": isp=item.getInputStream();
                       ...
                       break;
                  case "EID": EID=item.getString();
                  		break;

               }
            }
            EligibilityDao dao=new EligibilityDao();
            int eid=dao.addEligibilityDoc(EID, dept, year, docName);

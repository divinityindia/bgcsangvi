...
/**
 * Servlet implementation class AcademicCalender
 */
@WebServlet("/dir1/AcademicCalender")
public class AcademicCalender extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       try{
            ...
            int aid=dao.addAcademicCalender(title,filename);
            ...
            if(aid != 0)
            {
            	...
            	dao2.uploadFileToBucket(Credentials, bucketName,"academic_calender/"+aid+"/"+filename, image, metadata);

...
/**
 * Servlet implementation class CyberSecurity
 */
@WebServlet("/dir1/CyberSecurity")
public class CyberSecurity extends HttpServlet {
		...
		if(bean.isQpaper())
		{
			try
			{
				...
				String filename="";
				  ...
				  CyberSecurityBean bean2=new CyberSecurityBean();
				  bean2.setSubject(fields.get("sub"));
				  bean2.setSemester(fields.get("sem"));
				  bean2.setDocument(filename);

				  CyberSecurityDao dao=new CyberSecurityDao();
				  int id=dao.addCyberSec(bean2);
		       ...
		       // image=images.get(key);
		    	...
		    	s3client.uploadfile(Credentials, bucketName, "CyberSecurity/"+id+"_"+filename, image, metadata);
		    	}
		    	...
		    	response.sendRedirect("CyberSecurity");

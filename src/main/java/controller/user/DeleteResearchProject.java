...
/**
 * Servlet implementation class DeleteResearchProject
 */
@WebServlet("/dir1/DeleteResearchProject")
public class DeleteResearchProject extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(bean.isResearch()){
			try{
				...
				int result=dao.DeleteResearchProject(IDs);

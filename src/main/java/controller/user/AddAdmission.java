...
/**
 * Servlet implementation class AddAdmission
 */
@WebServlet("/dir1/AddAdmission")
public class AddAdmission extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		if(bean.isUGC_Community_College()){
			try
			{
			 RequestDispatcher rd=request.getRequestDispatcher("AddAdmission.jsp");
			 PolicyProcedureDao dao=new PolicyProcedureDao();
			 request.setAttribute("dtl",dao.getAllAddAdmission());
		...
		if(bean.isUGC_Community_College())
		{
			...
			try
			{
		       ...
		       // image=images.get(key);
		    	...
		    	s3client.uploadfile(Credentials, bucketName, "AddAdmission/"+id+"_"+filename, image, metadata);
		    	}
		    	...
		    	response.sendRedirect("AddAdmission");

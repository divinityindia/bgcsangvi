...
/**
 * Servlet implementation class DeptAboutController
 */
@WebServlet("/dir1/DeptAboutController")
public class DeptAboutController extends HttpServlet {
		...
		if(bean.isUGC_BSR())
		{
			try
			{
		       ...
		       // image=images.get(key);
		    	...
		    	about.setImgname(fields.get("imgnm"));
		    	about.setImage(filename);
		    	
		    	DeptAboutDao dao=new DeptAboutDao();
		    	
		    
		     int getid=dao.addAboutDep(about);
		    ...
		    /* DeptDao dao2=new DeptDao();
		     ...
		     response.sendRedirect("DeptAboutDtlController?id="+getid+"&did="+fields.get("did")+"&dnm="+dpname);*/
		    	...
		    	System.out.println("In side DeptAboutController post method");

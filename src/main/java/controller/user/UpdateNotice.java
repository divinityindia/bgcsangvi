				...
				NewsBean bean=new NewsBean();
				 ...
				 DiskFileItemFactory factory = new DiskFileItemFactory();
		            ...
		            if(nid != 0)
		            {
		            	...
		            	dao2.uploadFileToBucket(Credentials, bucketName, "notice/"+bean.getNID()+"/"+bean.getDocumentname(), image, metadata);
